...
int32_t imx111_actuator_write_focus(
	struct msm_actuator_ctrl_t *a_ctrl,
...
int32_t imx111_actuator_init_focus(struct msm_actuator_ctrl_t *a_ctrl,
	uint16_t size, enum msm_actuator_data_type type,
	struct reg_settings_t *settings);
	
int32_t imx111_actuator_parse_i2c_params(struct msm_actuator_ctrl_t *a_ctrl,
...
//		.actuator_init_step_table = msm_actuator_init_step_table,
		...
		.actuator_write_focus = imx111_actuator_write_focus,
		.actuator_set_default_focus = imx111_actuator_set_default_focus,
		.actuator_init_focus = imx111_actuator_init_focus,
		#if 0
		.actuator_i2c_write = msm_actuator_i2c_write,
		#else
		.actuator_parse_i2c_params = imx111_actuator_parse_i2c_params,
		#endif
	},
};
