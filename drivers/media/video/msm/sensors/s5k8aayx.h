/* drivers/media/video/msm/sensors/s5k8aayx.h (Camera Driver)
 *
...
//
// Preview config[0] : 1280x960 @30-7.5fps
...
// 02.ETC Setting
//==================================================================================
struct msm_camera_i2c_reg_conf s5k8aayx_sensor_init_settings_array[] = {
...
//Input Clock (Mclk)
    {0x002A,    0x012E},
    {0x0F12,    0x34BC},	//REG_TC_IPRM_InClockLSBs //13.500MHz
...
//System Clock & Output clock (Pclk)
    #if defined(CONFIG_MACH_KUR)
    {0x002A,    0x014C},
    {0x0F12,    0x2C4A},	//REG_TC_IPRM_OpClk4KHz_0	// 45.3516MHz
    {0x002A,    0x0152},
    {0x0F12,    0x5893},	//REG_TC_IPRM_MinOutRate4KHz_0	// 90.7031MHz
    {0x002A,    0x014E},
    {0x0F12,    0x5894},	//REG_TC_IPRM_MaxOutRate4KHz_0
    #else
    {0x002A,    0x014C},
    {0x0F12,    0x2EC3},	//REG_TC_IPRM_OpClk4KHz_0	// 47.88281MHz
    {0x002A,    0x0152},
    {0x0F12,    0x5D85},	//REG_TC_IPRM_MinOutRate4KHz_0	// 95.76563MHz
    {0x002A,    0x014E},
    {0x0F12,    0x5D86},	//REG_TC_IPRM_MaxOutRate4KHz_0
    #endif /* defined(CONFIG_MACH_KUR) */
    {0x002A,    0x0164},
...
//==================================================================================
    ...
    {0x0F12,    0x3165},  //1E65	//AfitBaseVals_1__52_ //sddd8a_DispTH_Low[7:0],sddd8a_DispTH_High[15:8]
    ...
    {0x0F12,    0x6464},  //1E50	//AfitBaseVals_2__52_ //sddd8a_DispTH_Low[7:0],sddd8a_DispTH_High[15:8]
...
//Preview config[0] 1280x960  30fps~7.5fps
    ...
    #else
    {0x0F12,    0x0012},	//REG_0TC_PCFG_PVIMask //52:YUV422; 42:RAW10 12:Non Continuous Mode
    #endif
    {0x002A,    0x01D4},
...
//Capture config[0] 1280x960  7.5fps
    ...
    #else
    {0x0F12,    0x0012},	//REG_0TC_CCFG_PVIMask //52:YUV422; 42:RAW10 12:Non Continuous Mode
    #endif
    {0x002A,    0x02C6},
...
//Preview
    ...
    {0x002A,    0x01EC},
    {0x0F12,    0x0005},	//REG_0TC_PCFG_uRotation
#endif
    {0x002A,    0x01A8},
...
#define S5K8AAYX_ALGORITHMSBIT_AE             0x0002
#define S5K8AAYX_ALGORITHMSBIT_AWB            0x0008
#define S5K8AAYX_ALGORITHMSBIT_FLICKER        0x0020

#define S5K8AAYX_FACTORY                      0xFCFC
#define S5K8AAYX_SETPAGE                      0x0028
#define S5K8AAYX_SETADDR                      0x002A
#define S5K8AAYX_READWRITE                    0x0F12

/* - EXPOSURE COMPENSATION - */
static struct msm_camera_i2c_reg_conf s5k8aayx_exposure[][4] = {
/* Brightness -12 */
{
{0xFCFC,0xD000},
{0x0028,0x7000},
...
static struct msm_camera_i2c_conf_array s5k8aayx_exposure_confs[][1] = {
	...
	{{s5k8aayx_exposure[4], ARRAY_SIZE(s5k8aayx_exposure[4]), 0,
		MSM_CAMERA_I2C_WORD_DATA},},
	{{s5k8aayx_exposure[5], ARRAY_SIZE(s5k8aayx_exposure[5]), 0,
		MSM_CAMERA_I2C_WORD_DATA},},
	{{s5k8aayx_exposure[6], ARRAY_SIZE(s5k8aayx_exposure[6]), 0,
		MSM_CAMERA_I2C_WORD_DATA},},
	{{s5k8aayx_exposure[7], ARRAY_SIZE(s5k8aayx_exposure[7]), 0,
		MSM_CAMERA_I2C_WORD_DATA},},
	{{s5k8aayx_exposure[8], ARRAY_SIZE(s5k8aayx_exposure[8]), 0,
		MSM_CAMERA_I2C_WORD_DATA},},
	{{s5k8aayx_exposure[9], ARRAY_SIZE(s5k8aayx_exposure[9]), 0,
		MSM_CAMERA_I2C_WORD_DATA},},
	{{s5k8aayx_exposure[10], ARRAY_SIZE(s5k8aayx_exposure[10]), 0,
		MSM_CAMERA_I2C_WORD_DATA},},
	{{s5k8aayx_exposure[11], ARRAY_SIZE(s5k8aayx_exposure[11]), 0,
		MSM_CAMERA_I2C_WORD_DATA},},
	{{s5k8aayx_exposure[12], ARRAY_SIZE(s5k8aayx_exposure[12]), 0,
		MSM_CAMERA_I2C_WORD_DATA},},
	{{s5k8aayx_exposure[13], ARRAY_SIZE(s5k8aayx_exposure[13]), 0,
		MSM_CAMERA_I2C_WORD_DATA},},
	{{s5k8aayx_exposure[14], ARRAY_SIZE(s5k8aayx_exposure[14]), 0,
		MSM_CAMERA_I2C_WORD_DATA},},
	{{s5k8aayx_exposure[15], ARRAY_SIZE(s5k8aayx_exposure[15]), 0,
		MSM_CAMERA_I2C_WORD_DATA},},
	{{s5k8aayx_exposure[16], ARRAY_SIZE(s5k8aayx_exposure[16]), 0,
		MSM_CAMERA_I2C_WORD_DATA},},
	{{s5k8aayx_exposure[17], ARRAY_SIZE(s5k8aayx_exposure[17]), 0,
		MSM_CAMERA_I2C_WORD_DATA},},
	{{s5k8aayx_exposure[18], ARRAY_SIZE(s5k8aayx_exposure[18]), 0,
		MSM_CAMERA_I2C_WORD_DATA},},
	{{s5k8aayx_exposure[19], ARRAY_SIZE(s5k8aayx_exposure[19]), 0,
		MSM_CAMERA_I2C_WORD_DATA},},
	{{s5k8aayx_exposure[20], ARRAY_SIZE(s5k8aayx_exposure[20]), 0,
		MSM_CAMERA_I2C_WORD_DATA},},
	{{s5k8aayx_exposure[21], ARRAY_SIZE(s5k8aayx_exposure[21]), 0,
		MSM_CAMERA_I2C_WORD_DATA},},
	{{s5k8aayx_exposure[22], ARRAY_SIZE(s5k8aayx_exposure[22]), 0,
		MSM_CAMERA_I2C_WORD_DATA},},
	{{s5k8aayx_exposure[23], ARRAY_SIZE(s5k8aayx_exposure[23]), 0,
		MSM_CAMERA_I2C_WORD_DATA},},
	{{s5k8aayx_exposure[24], ARRAY_SIZE(s5k8aayx_exposure[24]), 0,
		MSM_CAMERA_I2C_WORD_DATA},}
};

static int s5k8aayx_exposure_enum_map[] = {
	MSM_V4L2_EXPOSURE_N12,
	MSM_V4L2_EXPOSURE_N11,
	MSM_V4L2_EXPOSURE_N10,
	MSM_V4L2_EXPOSURE_N9,
	MSM_V4L2_EXPOSURE_N8,
	MSM_V4L2_EXPOSURE_N7,
	...
	MSM_V4L2_EXPOSURE_P7,
	MSM_V4L2_EXPOSURE_P8,
	MSM_V4L2_EXPOSURE_P9,
	MSM_V4L2_EXPOSURE_P10,
	MSM_V4L2_EXPOSURE_P11,
	MSM_V4L2_EXPOSURE_P12
};
...
/* - WHITE BALANCE - */
/* WHITEBALNACE AUTO */
static struct msm_camera_i2c_reg_conf s5k8aayx_wb_oem_auto[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x0408},
...
/* INCANDESCENT */
static struct msm_camera_i2c_reg_conf s5k8aayx_wb_oem_incandescent[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x0408},
...
{0x0F12,0x09B0},	//REG_SF_USER_Bgain
{0x0F12,0x0001},	//REG_SF_USER_BgainChanged
};
/* FLOURESCENT */
static struct msm_camera_i2c_reg_conf s5k8aayx_wb_oem_flourescent[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x0408},
{0x0F12,0x0677},	//REG_TC_DBG_AutoAlgEnBits
{0x002A,0x03DA},
{0x0F12,0x0490},	//REG_SF_USER_Rgain
{0x0F12,0x0001},	//REG_SF_USER_RgainChanged
{0x0F12,0x0400},	//REG_SF_USER_Ggain
{0x0F12,0x0001},	//REG_SF_USER_GgainChanged
...
/* DAYLIGHT */
static struct msm_camera_i2c_reg_conf s5k8aayx_wb_oem_daylight[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x0408},
{0x0F12,0x0677},	//REG_TC_DBG_AutoAlgEnBits
{0x002A,0x03DA},
{0x0F12,0x0538},	//REG_SF_USER_Rgain
{0x0F12,0x0001},	//REG_SF_USER_RgainChanged
{0x0F12,0x0400},	//REG_SF_USER_Ggain
{0x0F12,0x0001},	//REG_SF_USER_GgainChanged
{0x0F12,0x0640},	//REG_SF_USER_Bgain
{0x0F12,0x0001},	//REG_SF_USER_BgainChanged
};
/* CLOUDY */
static struct msm_camera_i2c_reg_conf s5k8aayx_wb_oem_cloudy[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x0408},
{0x0F12,0x0677},	//REG_TC_DBG_AutoAlgEnBits
{0x002A,0x03DA},
{0x0F12,0x0550},	//REG_SF_USER_Rgain
{0x0F12,0x0001},	//REG_SF_USER_RgainChanged
{0x0F12,0x0400},	//REG_SF_USER_Ggain
{0x0F12,0x0001},	//REG_SF_USER_GgainChanged
{0x0F12,0x05BD},	//REG_SF_USER_Bgain
{0x0F12,0x0001},	//REG_SF_USER_BgainChanged
};

static struct msm_camera_i2c_conf_array s5k8aayx_wb_oem_confs[][1] = {
	{{s5k8aayx_wb_oem_auto, ARRAY_SIZE(s5k8aayx_wb_oem_auto),  0,
		MSM_CAMERA_I2C_WORD_DATA},},
	{{s5k8aayx_wb_oem_incandescent, ARRAY_SIZE(s5k8aayx_wb_oem_incandescent),  0,
		MSM_CAMERA_I2C_WORD_DATA},},
	{{s5k8aayx_wb_oem_flourescent, ARRAY_SIZE(s5k8aayx_wb_oem_flourescent),  0,
		MSM_CAMERA_I2C_WORD_DATA},},
	{{s5k8aayx_wb_oem_daylight, ARRAY_SIZE(s5k8aayx_wb_oem_daylight),  0,
		MSM_CAMERA_I2C_WORD_DATA},},
	{{s5k8aayx_wb_oem_cloudy, ARRAY_SIZE(s5k8aayx_wb_oem_cloudy),  0,
		MSM_CAMERA_I2C_WORD_DATA},},
};
...
/* - BESTSHOT - */
static struct msm_camera_i2c_reg_conf s5k8aayx_bestshot[][4] = {
/* OFF */
{
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x018E},    //REG_TC_UserBrightness
{0x0F12,0x0000},
},
{
/* PORTRAIT */
...
{0x0028,0x7000},
{0x002A,0x018E},    //REG_TC_UserBrightness
{0x0F12,0x0020},    //For Portrait
},
};

static struct msm_camera_i2c_conf_array s5k8aayx_bestshot_confs[][1] = {
	{{s5k8aayx_bestshot[0], ARRAY_SIZE(s5k8aayx_bestshot[0]),  0,
		MSM_CAMERA_I2C_WORD_DATA},},
	{{s5k8aayx_bestshot[1], ARRAY_SIZE(s5k8aayx_bestshot[1]),  0,
		MSM_CAMERA_I2C_WORD_DATA},},
};

static int s5k8aayx_bestshot_enum_map[] = {
	MSM_V4L2_BESTSHOT_OFF,
	MSM_V4L2_BESTSHOT_PORTRAIT,
};

static struct msm_camera_i2c_enum_conf_array s5k8aayx_bestshot_enum_confs = {
	.conf = &s5k8aayx_bestshot_confs[0][0],
	.conf_enum = s5k8aayx_bestshot_enum_map,
	.num_enum = ARRAY_SIZE(s5k8aayx_bestshot_enum_map),
	.num_index = ARRAY_SIZE(s5k8aayx_bestshot_confs),
	.num_conf = ARRAY_SIZE(s5k8aayx_bestshot_confs[0]),
	.data_type = MSM_CAMERA_I2C_WORD_DATA,
};

/* - AEC AWB LOCK - */
/* UNLOCK */
static struct msm_camera_i2c_reg_conf s5k8aayx_algorithms_unlock[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x0408},  //REG_TC_DBG_AutoAlgEnBits
{0x0F12,0x067F},
...
/* LOCK */
static struct msm_camera_i2c_reg_conf s5k8aayx_algorithms_lock[] = {
{0xFCFC,0xD000},
{0x0028,0x7000},
{0x002A,0x0408},  //REG_TC_DBG_AutoAlgEnBits
{0x0F12,0x067D},
...
static struct msm_camera_i2c_conf_array s5k8aayx_algorithms_lock_confs[][1] = {
	{{s5k8aayx_algorithms_unlock, ARRAY_SIZE(s5k8aayx_algorithms_unlock),  0,
		MSM_CAMERA_I2C_WORD_DATA},},
	{{s5k8aayx_algorithms_lock, ARRAY_SIZE(s5k8aayx_algorithms_lock),  0,
		MSM_CAMERA_I2C_WORD_DATA},},
};

static int s5k8aayx_algorithms_lock_enum_map[] = {
	MSM_V4L2_UNLOCK,
	MSM_V4L2_LOCK,
};

static struct msm_camera_i2c_enum_conf_array s5k8aayx_algorithms_lock_enum_confs = {
	.conf = &s5k8aayx_algorithms_lock_confs[0][0],
	.conf_enum = s5k8aayx_algorithms_lock_enum_map,
	.num_enum = ARRAY_SIZE(s5k8aayx_algorithms_lock_enum_map),
	.num_index = ARRAY_SIZE(s5k8aayx_algorithms_lock_confs),
	.num_conf = ARRAY_SIZE(s5k8aayx_algorithms_lock_confs[0]),
	.data_type = MSM_CAMERA_I2C_WORD_DATA,
};

/* - ANTIBANDING - */
/* auto */
static struct msm_camera_i2c_reg_conf s5k8aayx_antibanding_auto[] = {
//077F    	REG_TC_DBG_AutoAlgEnBits                  	2   70000408
//0000    	REG_SF_USER_FlickerQuant                  	2   700003F4
//0000    	AFC_Default60Hz                           	2   70000ABC
//0000    	REG_SF_USER_FlickerQuantChanged           	2   700003F6
...
/* Band 60Hz */
static struct msm_camera_i2c_reg_conf s5k8aayx_antibanding_60Hz[] = {
//077F    	REG_TC_DBG_AutoAlgEnBits                  	2   70000408
//0000    	REG_SF_USER_FlickerQuant                  	2   700003F4
//0000    	AFC_Default60Hz                           	2   70000ABC
//0000    	REG_SF_USER_FlickerQuantChanged           	2   700003F6
...
{0x002A,0x03F4},
{0x0F12,0x0002},   //REG_SF_USER_FlickerQuant	0: no AFC, 1: 50 Hz, 2: 60 Hz
{0x0F12,0x0001},   //REG_SF_USER_FlickerQuantChanged
};

/* Band 50Hz */
static struct msm_camera_i2c_reg_conf s5k8aayx_antibanding_50Hz[] = {
//077F    	REG_TC_DBG_AutoAlgEnBits                  	2   70000408
//0000    	REG_SF_USER_FlickerQuant                  	2   700003F4
//0000    	AFC_Default60Hz                           	2   70000ABC
//0000    	REG_SF_USER_FlickerQuantChanged           	2   700003F6
...
{0x002A,0x03F4},
{0x0F12,0x0001},   //REG_SF_USER_FlickerQuant	0: no AFC, 1: 50 Hz, 2: 60 Hz
{0x0F12,0x0001},   //REG_SF_USER_FlickerQuantChanged
};

/* Off */
static struct msm_camera_i2c_reg_conf s5k8aayx_antibanding_off[] = {
//077F    	REG_TC_DBG_AutoAlgEnBits                  	2   70000408
//0000    	REG_SF_USER_FlickerQuant                  	2   700003F4
//0000    	AFC_Default60Hz                           	2   70000ABC
//0000    	REG_SF_USER_FlickerQuantChanged           	2   700003F6
...
static struct msm_camera_i2c_conf_array s5k8aayx_antibanding_confs[][1] = {
	{{s5k8aayx_antibanding_off, ARRAY_SIZE(s5k8aayx_antibanding_off),  0,
		MSM_CAMERA_I2C_WORD_DATA},},
	{{s5k8aayx_antibanding_60Hz, ARRAY_SIZE(s5k8aayx_antibanding_60Hz),  0,
		MSM_CAMERA_I2C_WORD_DATA},},
	{{s5k8aayx_antibanding_50Hz, ARRAY_SIZE(s5k8aayx_antibanding_50Hz),  0,
		MSM_CAMERA_I2C_WORD_DATA},},
	{{s5k8aayx_antibanding_auto, ARRAY_SIZE(s5k8aayx_antibanding_auto),  0,
		MSM_CAMERA_I2C_WORD_DATA},},
};
...
/* - FRAME RATE - */
static struct msm_camera_i2c_reg_conf s5k8aayx_frame_rate[][9] = {
/* 15FIX */
{
{0xFCFC,0xD000},
{0x0028,0x7000},
...
static struct msm_camera_i2c_conf_array s5k8aayx_frame_rate_confs[][1] = {
	{{s5k8aayx_frame_rate[0], ARRAY_SIZE(s5k8aayx_frame_rate[0]),  0,
		MSM_CAMERA_I2C_WORD_DATA},},
	{{s5k8aayx_frame_rate[1], ARRAY_SIZE(s5k8aayx_frame_rate[1]),  0,
		MSM_CAMERA_I2C_WORD_DATA},},
	{{s5k8aayx_frame_rate[2], ARRAY_SIZE(s5k8aayx_frame_rate[2]),  0,
		MSM_CAMERA_I2C_WORD_DATA},},
};

static int s5k8aayx_frame_rate_enum_map[] = {
	MSM_V4L2_FPS_15FIX,
	MSM_V4L2_FPS_30_7P5AUTO,
	MSM_V4L2_FPS_30FIX,
};

static struct msm_camera_i2c_enum_conf_array s5k8aayx_frame_rate_enum_confs = {
	.conf = &s5k8aayx_frame_rate_confs[0][0],
	.conf_enum = s5k8aayx_frame_rate_enum_map,
	.num_enum = ARRAY_SIZE(s5k8aayx_frame_rate_enum_map),
	.num_index = ARRAY_SIZE(s5k8aayx_frame_rate_confs),
	.num_conf = ARRAY_SIZE(s5k8aayx_frame_rate_confs[0]),
	.data_type = MSM_CAMERA_I2C_WORD_DATA,
};
...
struct msm_sensor_v4l2_ctrl_info_t s5k8aayx_v4l2_ctrl_info[] = {
	...
	{
		.ctrl_id = V4L2_CID_BESTSHOT,
		.min = MSM_V4L2_BESTSHOT_OFF,
		.max = MSM_V4L2_BESTSHOT_PORTRAIT,
		.step = 1,
		.enum_cfg_settings = &s5k8aayx_bestshot_enum_confs,
		.s_v4l2_ctrl = s5k8aayx_msm_sensor_s_ctrl_by_enum,
	},
	{
		.ctrl_id = V4L2_CID_AEC_LOCK,
		.min = MSM_V4L2_UNLOCK,
		.max = MSM_V4L2_LOCK,
		.step = 1,
		.enum_cfg_settings = &s5k8aayx_algorithms_lock_enum_confs,
		.s_v4l2_ctrl = s5k8aayx_aec_lock_msm_sensor_s_ctrl_by_enum,
	},
	{
		.ctrl_id = V4L2_CID_AWB_LOCK,
		.min = MSM_V4L2_UNLOCK,
		.max = MSM_V4L2_LOCK,
		.step = 1,
		.enum_cfg_settings = &s5k8aayx_algorithms_lock_enum_confs,
		.s_v4l2_ctrl = s5k8aayx_awb_lock_msm_sensor_s_ctrl_by_enum,
	},
	{
	...
	{
		.ctrl_id = V4L2_CID_FRAME_RATE,
		.min = MSM_V4L2_FPS_15FIX,
		.max = MSM_V4L2_FPS_30FIX,
		.step = 1,
		.enum_cfg_settings = &s5k8aayx_frame_rate_enum_confs,
		.s_v4l2_ctrl = s5k8aayx_msm_sensor_s_ctrl_by_enum,
	},
};
...
static struct msm_camera_i2c_reg_conf s5k8aayx_start_settings[] = {
    ...
    {0x0028,    0x7000},
    {0x002A,    0x019E},
    {0x0F12,    0x0001},  /* REG_TC_GP_EnablePreview #enable */
    {0x0F12,    0x0001},  /* REG_TC_GP_EnablePreviewChanged */
};
...
static struct msm_camera_i2c_reg_conf s5k8aayx_stop_settings[] = {
    ...
    {0x0028,    0x7000},
    {0x002A,    0x019E},
    {0x0F12,    0x0000},  /* REG_TC_GP_EnablePreview #disable */
    {0x0F12,    0x0001},  /* REG_TC_GP_EnablePreviewChanged */
};

/*------ Preview Size Table ------*/
/*------ 1280 x 960 ( 4:3) ------*/
static struct msm_camera_i2c_reg_conf s5k8aayx_prev_full_array[] = {
    {0xFCFC,    0xD000},
    {0x0028,    0x7000},
    {0x002A,    0x01BE},
    {0x0F12,    0x0500},
...
/*------ 1280 x 720 (16:9) ------*/
static struct msm_camera_i2c_reg_conf s5k8aayx_prev_hd720_array[] = {
    {0xFCFC,    0xD000},
    {0x0028,    0x7000},
    {0x002A,    0x01BE},
    {0x0F12,    0x0500},
...
/*------  640 x 480 ( 4:3) ------*/
static struct msm_camera_i2c_reg_conf s5k8aayx_prev_vga_array[] = {
    {0xFCFC,    0xD000},
    {0x0028,    0x7000},
    {0x002A,    0x01BE},
    {0x0F12,    0x0280},
...
/*------  320 x 240 ( 4:3) ------*/
static struct msm_camera_i2c_reg_conf s5k8aayx_prev_qvga_array[] = {
    {0xFCFC,    0xD000},
    {0x0028,    0x7000},
    {0x002A,    0x01BE},
    {0x0F12,    0x0140},
...
/*------  176 x 144 ( 4:3) ------*/
static struct msm_camera_i2c_reg_conf s5k8aayx_prev_qcif_array[] = {
    {0xFCFC,    0xD000},
    {0x0028,    0x7000},
    {0x002A,    0x01BE},
    {0x0F12,    0x00B0},
