...
#ifdef CONFIG_PMIC8XXX_SCPWRKEY
...
#ifdef CONFIG_PMIC8XXX_SCPWRKEY
/* Debug Log */
#define SHPWRKEY_LOG_TAG_H   "pwrkey:"
#define SHPWRKEY_DEBUG_LOG_H(fmt, args...)	printk(KERN_INFO "%s " fmt"\n", SHPWRKEY_LOG_TAG_H, ## args)
#endif
...
#ifdef CONFIG_PMIC8XXX_SCPWRKEY
static struct wake_lock pwrkey_wake_lock;
#define PWRKEY_WAKE_LOCK_TIMEOUT	1*HZ/2
#endif
...
#ifdef CONFIG_PMIC8XXX_SCPWRKEY
	SHPWRKEY_DEBUG_LOG_H("press");
	wake_lock_timeout(&pwrkey_wake_lock, PWRKEY_WAKE_LOCK_TIMEOUT);
#endif	/* CONFIG_PMIC8XXX_SCPWRKEY */
...
#ifdef CONFIG_PMIC8XXX_SCPWRKEY
    wake_lock_init(&pwrkey_wake_lock, WAKE_LOCK_SUSPEND, "pwrkey_wake_lock");
#endif
...
#ifndef CONFIG_PMIC8XXX_SCPWRKEY
	if (pwrkey->press) {
		input_report_key(pwrkey->pwr, KEY_POWER, 1);
		input_sync(pwrkey->pwr);
	}
...
unreg_input_dev:
#ifdef CONFIG_PMIC8XXX_SCPWRKEY
	wake_lock_destroy(&pwrkey_wake_lock);
#endif
