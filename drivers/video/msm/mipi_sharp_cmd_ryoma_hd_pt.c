/* drivers/video/msm/mipi_sharp_cmd_ryoma_hd_pt.c  (Display Driver)
 *
...
static struct mipi_dsi_phy_ctrl dsi_cmd_mode_phy_db = {
	...
	/* timing    */
	{0x6B, 0x23, 0x1A, 0x00, 0x5F, 0x32, 0x1E, 0x25, 0x1E, 0x03, 0x04, 0x00},
	/* phy ctrl  */
	{0x7F, 0x00, 0x00, 0x10},
	/* strength  */
	{0xEE, 0x02, 0x86, 0x00},
	...
	{0x00, 0x52, 0x31, 0xD6, 0x00, 0x50, 0x48, 0x63,
#else
	{0x00, 0xF8, 0x30, 0xCF, 0x00, 0x50, 0x48, 0x63,
#endif /* CONFIG_MACH */
	 0x31, 0x0F, 0x03, /*  --> Four lane configuration */
	 0x05, 0x14, 0x03, 0x00, 0x02, 0x54, 0x06, 0x10, 0x04, 0x00},
};

static int __init mipi_cmd_sharp_ryoma_hd_pt_init(void)
{
	int ret;
	...
	if (msm_fb_detect_client("mipi_cmd_sharp_ryoma_hd")){
	    printk(KERN_INFO "[SHDISP] %s msm_fb_detect_client\n", __func__);
		return 0;
	}
...
#else
    pinfo.clk_rate = 420190000;
    pinfo.clk_min  = 420190000;
    pinfo.clk_max  = 420190000;
#endif /* CONFIG_MACH */
	pinfo.is_3d_panel = 0;
...
module_init(mipi_cmd_sharp_ryoma_hd_pt_init);
