...
#include "../../sharp/shdisp/data/shdisp_cabc_ryoma_data_dl20.h"
#elif defined(CONFIG_MACH_KUR)
#include "../../sharp/shdisp/data/shdisp_cabc_ryoma_data_pa16.h"
#else
...
#define MIPI_SH_RYOMA_RW_MAX_SIZE       47
...
static struct dsi_buf mipi_sh_ryoma_tx_buf;
static struct dsi_buf mipi_sh_ryoma_rx_buf;
static int mipi_sh_ryoma_ch_used[3];
static int mipi_sh_ryoma_deviceid_out = 0;
...
static char mipi_sh_ryoma_set_val_cabc_lut1_gamma_a[CABC_LUT_TABLE_SIZE];
static char mipi_sh_ryoma_set_val_cabc_lut1_gamma_b[CABC_LUT_TABLE_SIZE];
static char mipi_sh_ryoma_set_val_cabc_lut1_gamma_c[CABC_LUT_TABLE_SIZE];
static char mipi_sh_ryoma_set_val_cabc_lut2_gamma_a[CABC_LUT_TABLE_SIZE];
static char mipi_sh_ryoma_set_val_cabc_lut2_gamma_b[CABC_LUT_TABLE_SIZE];
static char mipi_sh_ryoma_set_val_cabc_lut2_gamma_c[CABC_LUT_TABLE_SIZE];
static char mipi_sh_ryoma_set_val_cabc_lut3_gamma_a[CABC_LUT_TABLE_SIZE];
static char mipi_sh_ryoma_set_val_cabc_lut3_gamma_b[CABC_LUT_TABLE_SIZE];
static char mipi_sh_ryoma_set_val_cabc_lut3_gamma_c[CABC_LUT_TABLE_SIZE];
static char mipi_sh_ryoma_set_val_cabc_lut4_gamma_a[CABC_LUT_TABLE_SIZE];
static char mipi_sh_ryoma_set_val_cabc_lut4_gamma_b[CABC_LUT_TABLE_SIZE];
static char mipi_sh_ryoma_set_val_cabc_lut4_gamma_c[CABC_LUT_TABLE_SIZE];
static char mipi_sh_ryoma_set_val_cabc_lut5_gamma_a[CABC_LUT_TABLE_SIZE];
static char mipi_sh_ryoma_set_val_cabc_lut5_gamma_b[CABC_LUT_TABLE_SIZE];
static char mipi_sh_ryoma_set_val_cabc_lut5_gamma_c[CABC_LUT_TABLE_SIZE];
static char mipi_sh_ryoma_set_val_cmd_timing4[14];

static char mipi_sh_ryoma_cmd_protect[2] = {0xB0, 0x00};
static char mipi_sh_ryoma_cmd_manufacture_id[2] = {0xBF, 0x00};
...
static char mipi_sh_ryoma_cmd_gamma_a[25] = {0xC7, 
    0x00,0x06,0x0C,0x13,0x20,0x36,0x26,0x34,0x41,0x4D,0x5E,0x6B,
    0x00,0x06,0x0C,0x13,0x20,0x36,0x26,0x32,0x3E,0x4A,0x5B,0x67};
...
static char mipi_sh_ryoma_cmd_power4[17] = {0xD9, 
    ...
    0x00,0xF0,0x33,0x33};
static char mipi_sh_ryoma_cmd_set_sync1[3] = {0xEC, 0x01,0x00};
static char mipi_sh_ryoma_cmd_set_sync2[6] = {0xED, 0x00,0x00,0x00,0x00,0x00};
...
static struct dsi_cmd_desc mipi_sh_ryoma_cmds_manufacture_id[] = {
    {DTYPE_GEN_READ1, 1, 0, 1, 0, sizeof(mipi_sh_ryoma_cmd_manufacture_id), mipi_sh_ryoma_cmd_manufacture_id}
};
...
static struct dsi_cmd_desc mipi_sh_ryoma_cmds_display_on_start[] = {
    {DTYPE_DCS_WRITE, 1, 0, 0, 90, sizeof(mipi_sh_ryoma_cmd_exit_sleep), mipi_sh_ryoma_cmd_exit_sleep}
};

static char mipi_sh_ryoma_cmd_low_power[2] = {0xD9, 0x00};
static char mipi_sh_ryoma_cmd_disp_off[2] = {0x28, 0x00};
static char mipi_sh_ryoma_cmd_vcom_off[9] = {0xD5, 
...
static struct dsi_cmd_desc mipi_sh_ryoma_cmds_display_off[] = {
    {DTYPE_GEN_LWRITE, 1, 0, 0, 18, sizeof(mipi_sh_ryoma_cmd_low_power), mipi_sh_ryoma_cmd_low_power},
    {DTYPE_DCS_WRITE, 1, 0, 0, 18, sizeof(mipi_sh_ryoma_cmd_disp_off), mipi_sh_ryoma_cmd_disp_off}
};
static struct dsi_cmd_desc mipi_sh_ryoma_cmds_display_off2[] = {
    {DTYPE_DCS_WRITE, 1, 0, 0, 108, sizeof(mipi_sh_ryoma_cmd_sleep_on), mipi_sh_ryoma_cmd_sleep_on},
    {DTYPE_GEN_WRITE2, 1, 0, 0, 18, sizeof(mipi_sh_ryoma_cmd_standby), mipi_sh_ryoma_cmd_standby}
};
...
static int mipi_sharp_ryoma_clk_write(struct msm_fb_data_type *mfd, int length);
static int mipi_sharp_ryoma_panel_sync_write(struct msm_fb_data_type *mfd);
#if defined(CONFIG_SHDISP_USE_CABC)
static int mipi_sharp_ryoma_cabc_lcd_backlight_on(void);
static int mipi_sharp_ryoma_cabc_pre_disp_on_ctrl(struct msm_fb_data_type *mfd, struct mipi_panel_info *mipi);
static int mipi_sharp_ryoma_cabc_disp_on_ctrl(struct msm_fb_data_type *mfd, struct mipi_panel_info *mipi);
#endif

static int mipi_sharp_ryoma_cmd_sqe_cabc_init(struct msm_fb_data_type *mfd, struct mipi_panel_info *mipi);
static int mipi_sharp_ryoma_cmd_sqe_cabc_indoor_on(struct msm_fb_data_type *mfd, struct mipi_panel_info *mipi);
static int mipi_sharp_ryoma_cmd_sqe_cabc_outdoor_on(struct msm_fb_data_type *mfd, struct mipi_panel_info *mipi, int lut_level);
static int mipi_sharp_ryoma_cmd_sqe_cabc_off(struct msm_fb_data_type *mfd, struct mipi_panel_info *mipi, int wait_on, int pwm_disable);
static int mipi_sharp_ryoma_cmd_sqe_cabc_outdoor_move(struct msm_fb_data_type *mfd, struct mipi_panel_info *mipi, int lut_level);
...
static void mipi_sharp_ryoma_cabc_acc_gamma_init(void);

#define PM8921_GPIO_BASE        NR_GPIO_IRQS
#define PM8921_GPIO_PM_TO_SYS(pm_gpio)  (pm_gpio - 1 + PM8921_GPIO_BASE)

static char mipi_sharp_ryoma_manufacture_id(struct msm_fb_data_type *mfd)
{
    struct dsi_buf *rp, *tp;
    struct dsi_cmd_desc *cmd;
    char *rdata;
    
    tp = &mipi_sh_ryoma_tx_buf;
    rp = &mipi_sh_ryoma_rx_buf;
    
    cmd = &mipi_sh_ryoma_cmds_manufacture_id[0];
    mipi_dsi_cmds_rx(mfd, tp, rp, cmd, 6);
    rdata = rp->data;
    if (mipi_sh_ryoma_deviceid_out == 0) {
        pr_info("[SHDISP]%s: BFh=%02x,%02x,%02x,%02x,%02x,%02x",
            __func__, *rdata,*(rdata+1),*(rdata+2),*(rdata+3),*(rdata+4),*(rdata+5));
        mipi_sh_ryoma_deviceid_out = 1;
    }
    
    return *(rdata+4);
}

static int mipi_sharp_ryoma_tx_vcom_write(struct msm_fb_data_type *mfd)
{
    ...
    if( (alpha == SHDISP_NOT_ADJUST_VCOM_VAL) || (alpha_low == SHDISP_NOT_ADJUST_VCOM_VAL) ) {
        ...
        data = (unsigned char) (alpha_low & 0xFF);
        data = (data + 1) / 2;
    ...
    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, cmd, ARRAY_SIZE(cmd));
    
    return 0;
}

static int mipi_sharp_ryoma_tx_vcom_off_write(struct msm_fb_data_type *mfd)
{
    struct dsi_cmd_desc cmd[1];
    char cmd_buf[13];
    int paramCnt;
...
static int mipi_sharp_ryoma_cmd_lcd_on(struct msm_fb_data_type *mfd, struct mipi_panel_info *mipi)
{
    char device_id = 0x00;
    ...
    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_protect,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_protect));
    device_id = mipi_sharp_ryoma_manufacture_id(mfd);
    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_init,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_init));
    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_timing1,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_timing1));
    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_gamma,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_gamma));
    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_power1,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_power1));
    mipi_sharp_ryoma_tx_vcom_write(mfd);
    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_power2,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_power2));

    memcpy(&mipi_sh_ryoma_clk_state[0], &mipi_sh_ryoma_cmd_power4[1], 16);

    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_sync,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_sync));

    memcpy(&mipi_sh_ryoma_panel_sync[0], &mipi_sh_ryoma_cmd_set_sync1[1], 2);

    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_display_on,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_display_on));
...
static int mipi_sharp_ryoma_cmd_lcd_off(struct msm_fb_data_type *mfd, struct mipi_panel_info *mipi)
{
    if(shdisp_api_get_upper_unit() != SHDISP_RESULT_SUCCESS) {
        return 0;
    }
    
    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_display_off,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_display_off));
    mipi_sh_ryoma_clk_state[0] = mipi_sh_ryoma_cmd_low_power[1];

    mipi_sharp_ryoma_tx_vcom_off_write(mfd);
    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_display_off2,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_display_off2));
...
static int mipi_sharp_ryoma_lcd_on(struct platform_device *pdev)
{
    ...
    if (mipi->mode == DSI_CMD_MODE) {
        ret = mipi_sharp_ryoma_cmd_lcd_on(mfd, mipi);
    }
    return ret;
}
...
static int mipi_sharp_ryoma_lcd_off(struct platform_device *pdev)
{
    ...
    mipi = &mfd->panel_info.mipi;
    if (mipi->mode == DSI_CMD_MODE) {
        ret = mipi_sharp_ryoma_cmd_lcd_off(mfd, mipi);
    }
...
static int mipi_sharp_ryoma_cmd_lcd_display_on(struct msm_fb_data_type *mfd, struct mipi_panel_info *mipi)
{
	if(shdisp_api_get_upper_unit() != SHDISP_RESULT_SUCCESS) {
		return -ENODEV;
	}
	mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_display_on_start,
						 ARRAY_SIZE(mipi_sh_ryoma_cmds_display_on_start));
	mipi_dsi_cmd_bta_sw_trigger();
	return 0;
}
...
static int mipi_sharp_ryoma_lcd_start_display(struct msm_fb_data_type *mfd)
{
	...
	if (mipi->mode == DSI_CMD_MODE) {
		...
		ret = mipi_sharp_ryoma_cmd_lcd_display_on(mfd, mipi);
...
static int mipi_sharp_ryoma_cabc_pre_disp_on_ctrl(struct msm_fb_data_type *mfd, struct mipi_panel_info *mipi)
{
    mipi_sharp_ryoma_cabc_lcd_backlight_on();

    mipi_sharp_ryoma_cmd_sqe_cabc_off(mfd, mipi, 0, 1);
...
static int mipi_sharp_ryoma_cabc_disp_on_ctrl(struct msm_fb_data_type *mfd, struct mipi_panel_info *mipi)
{
    ...
    {
        mipi_sharp_ryoma_cmd_sqe_cabc_init(mfd, mipi);

        mipi_sharp_ryoma_cmd_sqe_cabc_indoor_on(mfd, mipi);
    }
    else if(value.old_mode == SHDISP_MAIN_DISP_CABC_MODE_OFF && value.mode == SHDISP_MAIN_DISP_CABC_MODE_ACC )
    {
        ...
        else
        {
            ...
            mipi_sharp_ryoma_cmd_sqe_cabc_outdoor_on(mfd, mipi, value.lut);
        }
    }
...
#else
            mipi_sharp_ryoma_cmd_sqe_cabc_off(mfd, mipi, 1, 0);
#endif /* CONFIG_MACH_*** */
    ...
    else if(value.old_mode == SHDISP_MAIN_DISP_CABC_MODE_ACC && value.mode == SHDISP_MAIN_DISP_CABC_MODE_ACC)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                mipi_sharp_ryoma_cmd_sqe_cabc_outdoor_move(mfd, mipi, value.lut);
            }
        }
    }
...
static int mipi_sharp_ryoma_clk_write(struct msm_fb_data_type *mfd, int length)
{
    ...
    cmd_buf[0] = 0xD9;
    memcpy(&cmd_buf[1], mipi_sh_ryoma_clk_state, length);
    cmd[0].dlen = length + 1;
...
static int mipi_sharp_ryoma_panel_sync_write(struct msm_fb_data_type *mfd)
{
    ...
    cmd_buf[0] = 0xEC;
    memcpy(&cmd_buf[1], mipi_sh_ryoma_panel_sync, 2);
    cmd[0].dlen = 3;
...
static int mipi_sharp_ryoma_set_lpf(struct msm_fb_data_type *mfd, struct mipi_panel_info *mipi, unsigned char *param)
{
    ...
    mipi_sh_ryoma_clk_state[0] = param[0];
    mipi_sh_ryoma_clk_state[1] = param[1];
...
static int mipi_sharp_ryoma_cmd_sqe_cabc_init(struct msm_fb_data_type *mfd, struct mipi_panel_info *mipi)
{
    mipi_sh_ryoma_clk_state[3] &= (unsigned char)~0x03;
    mipi_sharp_ryoma_clk_write(mfd,4);

    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_init_set_pwm,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_init_set_pwm));
    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_init_set_para,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_init_set_para));
    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_init_set_flicker,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_init_set_flicker));
    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_init_set_connector,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_init_set_connector));
    
    
    mipi_sh_ryoma_panel_sync[1] = ((unsigned char)~0x70 & mipi_sh_ryoma_panel_sync[1]) | (0x70 & 0x40);
    mipi_sharp_ryoma_panel_sync_write(mfd);

    mipi_sharp_ryoma_cmd_sqe_cabc_trv_primary_setting(mfd);

    mipi_sharp_delay_us(SHDISP_RYOMA_1V_WAIT);

    mipi_sh_ryoma_clk_state[3] |= 0x03;
    mipi_sharp_ryoma_clk_write(mfd,4);
...
static int mipi_sharp_ryoma_cmd_sqe_cabc_indoor_on(struct msm_fb_data_type *mfd, struct mipi_panel_info *mipi)
{
    ...
    if((mipi_sh_ryoma_clk_state[0] & 0x01 ) == 0x01)
    {
        low_power_mode = 1;
    }
    ...
    if( low_power_mode == 1 )
    {
        mipi_sh_ryoma_clk_state[0] &= (unsigned char)~0x01;
        mipi_sharp_ryoma_clk_write(mfd, 1);

        mipi_sharp_delay_us(SHDISP_RYOMA_1V_WAIT);
    }


    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_indoor_set_image_exrate_lut0,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_indoor_set_image_exrate_lut0));

    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_indoor_set_flicker,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_indoor_set_flicker));

    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_indoor_set_on,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_indoor_set_on));
    
    mipi_sharp_delay_us(SHDISP_RYOMA_1V_WAIT);

    if( low_power_mode == 1 )
    {
        mipi_sh_ryoma_clk_state[0] |= 0x01;
        mipi_sharp_ryoma_clk_write(mfd, 1);
    }
...
static int mipi_sharp_ryoma_cmd_sqe_cabc_outdoor_on(struct msm_fb_data_type *mfd, struct mipi_panel_info *mipi, int lut_level)
{
    ...
    case SHDISP_MAIN_DISP_CABC_LUT1:
        mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_outdoor_set_image_exrate_lut1,
                         ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_outdoor_set_image_exrate_lut1));
        break;
    case SHDISP_MAIN_DISP_CABC_LUT2:
        mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_outdoor_set_image_exrate_lut2,
                         ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_outdoor_set_image_exrate_lut2));
        break;
    case SHDISP_MAIN_DISP_CABC_LUT3:
        mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_outdoor_set_image_exrate_lut3,
                         ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_outdoor_set_image_exrate_lut3));
        break;
    case SHDISP_MAIN_DISP_CABC_LUT4:
        mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_outdoor_set_image_exrate_lut4,
                         ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_outdoor_set_image_exrate_lut4));
        break;
    case SHDISP_MAIN_DISP_CABC_LUT5:
        mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_outdoor_set_image_exrate_lut5,
                         ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_outdoor_set_image_exrate_lut5));
        break;
	}

    mipi_sharp_ryoma_cmd_sqe_cabc_trv_lut_setting(mfd, lut_level);

    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_outdoor_set_flicker,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_outdoor_set_flicker));

    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_outdoor_set_on,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_outdoor_set_on));
...
static int mipi_sharp_ryoma_cmd_sqe_cabc_off(struct msm_fb_data_type *mfd, struct mipi_panel_info *mipi, int wait_on, int pwm_disable)
{
    ...
    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_off_set_image_exrate_lut0,
             ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_off_set_image_exrate_lut0));

    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_off_set_off,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_off_set_off));
...
static int mipi_sharp_ryoma_cmd_sqe_cabc_outdoor_move(struct msm_fb_data_type *mfd, struct mipi_panel_info *mipi, int lut_level)
{
    ...
    mipi_sh_ryoma_clk_state_bak[0] = mipi_sh_ryoma_clk_state[0];
    mipi_sh_ryoma_clk_state_bak[1] = mipi_sh_ryoma_clk_state[1];

    mipi_sh_ryoma_clk_state[1] = 0x68;
    mipi_sharp_ryoma_clk_write(mfd, 2);

    mipi_sh_ryoma_clk_state[0] |= 0x01;
    mipi_sh_ryoma_clk_state[2] = 0x43;
    mipi_sharp_ryoma_clk_write(mfd, 3);

    mipi_sharp_delay_us(SHDISP_RYOMA_1V_WAIT);

    mipi_sh_ryoma_clk_state[2] = 0x03;
    mipi_sharp_ryoma_clk_write(mfd, 3);
    ...
    {
    case SHDISP_MAIN_DISP_CABC_LUT1:
        mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_transition_set_image_exrate_lut1,
                         ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_transition_set_image_exrate_lut1));
        break;
    case SHDISP_MAIN_DISP_CABC_LUT2:
        mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_transition_set_image_exrate_lut2,
                         ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_transition_set_image_exrate_lut2));
        break;
    case SHDISP_MAIN_DISP_CABC_LUT3:
        mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_transition_set_image_exrate_lut3,
                         ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_transition_set_image_exrate_lut3));
        break;
    case SHDISP_MAIN_DISP_CABC_LUT4:
        mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_transition_set_image_exrate_lut4,
                         ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_transition_set_image_exrate_lut4));
        break;
    case SHDISP_MAIN_DISP_CABC_LUT5:
        mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_transition_set_image_exrate_lut5,
                         ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_transition_set_image_exrate_lut5));
        break;
	}
    ...
    mipi_sh_ryoma_clk_state[1] = mipi_sh_ryoma_clk_state_bak[1];
    mipi_sh_ryoma_clk_state[2] = 0x4F;
    mipi_sharp_ryoma_clk_write(mfd, 3);
...
static int mipi_sharp_ryoma_cmd_sqe_cabc_trv_primary_setting(struct msm_fb_data_type *mfd)
{
    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_bank_lock,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_bank_lock));
    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_bank_01,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_bank_01));
    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_trv_lock0,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_trv_lock0));
    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_trv_lock1,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_trv_lock1));
    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_bank_00,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_bank_00));
    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_fntn_s,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_fntn_s));
    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_bank_01,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_bank_01));
    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_trv_mode_set,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_trv_mode_set));
    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_bank_00,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_bank_00));
    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_val_go,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_val_go));
...
static void mipi_sharp_ryoma_cabc_acc_gamma_init(void)
{
    memcpy(mipi_sh_ryoma_set_val_cabc_lut1_gamma_a, mipi_sh_ryoma_set_val_gamma_a, CABC_LUT_TABLE_SIZE);
    memcpy(mipi_sh_ryoma_set_val_cabc_lut1_gamma_b, mipi_sh_ryoma_set_val_gamma_b, CABC_LUT_TABLE_SIZE);
    memcpy(mipi_sh_ryoma_set_val_cabc_lut1_gamma_c, mipi_sh_ryoma_set_val_gamma_c, CABC_LUT_TABLE_SIZE);
    memcpy(mipi_sh_ryoma_set_val_cabc_lut2_gamma_a, mipi_sh_ryoma_set_val_gamma_a, CABC_LUT_TABLE_SIZE);
    memcpy(mipi_sh_ryoma_set_val_cabc_lut2_gamma_b, mipi_sh_ryoma_set_val_gamma_b, CABC_LUT_TABLE_SIZE);
    memcpy(mipi_sh_ryoma_set_val_cabc_lut2_gamma_c, mipi_sh_ryoma_set_val_gamma_c, CABC_LUT_TABLE_SIZE);
    memcpy(mipi_sh_ryoma_set_val_cabc_lut3_gamma_a, mipi_sh_ryoma_set_val_gamma_a, CABC_LUT_TABLE_SIZE);
    memcpy(mipi_sh_ryoma_set_val_cabc_lut3_gamma_b, mipi_sh_ryoma_set_val_gamma_b, CABC_LUT_TABLE_SIZE);
    memcpy(mipi_sh_ryoma_set_val_cabc_lut3_gamma_c, mipi_sh_ryoma_set_val_gamma_c, CABC_LUT_TABLE_SIZE);
    memcpy(mipi_sh_ryoma_set_val_cabc_lut4_gamma_a, mipi_sh_ryoma_set_val_gamma_a, CABC_LUT_TABLE_SIZE);
    memcpy(mipi_sh_ryoma_set_val_cabc_lut4_gamma_b, mipi_sh_ryoma_set_val_gamma_b, CABC_LUT_TABLE_SIZE);
    memcpy(mipi_sh_ryoma_set_val_cabc_lut4_gamma_c, mipi_sh_ryoma_set_val_gamma_c, CABC_LUT_TABLE_SIZE);
    memcpy(mipi_sh_ryoma_set_val_cabc_lut5_gamma_a, mipi_sh_ryoma_set_val_gamma_a, CABC_LUT_TABLE_SIZE);
    memcpy(mipi_sh_ryoma_set_val_cabc_lut5_gamma_b, mipi_sh_ryoma_set_val_gamma_b, CABC_LUT_TABLE_SIZE);
    memcpy(mipi_sh_ryoma_set_val_cabc_lut5_gamma_c, mipi_sh_ryoma_set_val_gamma_c, CABC_LUT_TABLE_SIZE);
...
static int mipi_sharp_ryoma_cmd_sqe_cabc_trv_lut_setting(struct msm_fb_data_type *mfd, int lut_level)
{
    ...
    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_trv_lut_set_on,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_trv_lut_set_on));
    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_bank_07,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_bank_07));
    ...
    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_bank_08,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_bank_08));
    ...
    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_bank_09,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_bank_09));
    ...
    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_bank_0A,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_bank_0A));
    ...
    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_bank_00,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_bank_00));
    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_trv_lut_set_off,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_trv_lut_set_off));
...
static int mipi_sharp_ryoma_cmd_sqe_cabc_trv_on(struct msm_fb_data_type *mfd)
{
    ...
    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_bank_01,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_bank_01));
    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_trv_on,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_trv_on));
    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_bank_00,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_bank_00));
    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_val_go,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_val_go));
...
static int mipi_sharp_ryoma_cmd_sqe_cabc_trv_off(struct msm_fb_data_type *mfd)
{
    ...
    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_bank_01,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_bank_01));
    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_trv_off,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_trv_off));
    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_bank_00,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_bank_00));
    mipi_dsi_cmds_tx(&mipi_sh_ryoma_tx_buf, mipi_sh_ryoma_cmds_cabc_val_go,
                     ARRAY_SIZE(mipi_sh_ryoma_cmds_cabc_val_go));
...
static int mipi_sharp_ryoma_cabc_ctrl(struct platform_device *pdev)
{
    ...
    mipi = &mfd->panel_info.mipi;
    if (mipi->mode == DSI_CMD_MODE) {
        ret = mipi_sharp_ryoma_cabc_disp_on_ctrl(mfd, mipi);
    }
...
static struct msm_fb_panel_data sharp_ryoma_panel_data = {
	...
	.cabc_init			= mipi_sharp_ryoma_cmd_sqe_cabc_init,
	.cabc_indoor_on		= mipi_sharp_ryoma_cmd_sqe_cabc_indoor_on,
	.cabc_outdoor_on	= mipi_sharp_ryoma_cmd_sqe_cabc_outdoor_on,
	.cabc_off			= mipi_sharp_ryoma_cmd_sqe_cabc_off,
	.cabc_outdoor_move	= mipi_sharp_ryoma_cmd_sqe_cabc_outdoor_move,
					...
					u32 channel, u32 panel)
{
	...
	if ((channel >= 3) || mipi_sh_ryoma_ch_used[channel])
		return -ENODEV;

	mipi_sh_ryoma_ch_used[channel] = TRUE;
...
int mipi_sharp_ryoma_diag_write_reg(unsigned char addr, unsigned char *write_data, unsigned char size)
{
    ...
    if(size > MIPI_SH_RYOMA_RW_MAX_SIZE) {
...
int mipi_sharp_ryoma_init_phy_gamma(struct shdisp_lcddr_phy_gamma_reg *phy_gamma)
{
    ...
    mipi_sharp_ryoma_cabc_acc_gamma_init();
    return ret;
}
...
static int __init mipi_sharp_ryoma_lcd_init(void)
{
    ...
    mipi_dsi_buf_alloc(&mipi_sh_ryoma_tx_buf, DSI_BUF_SIZE);
    mipi_dsi_buf_alloc(&mipi_sh_ryoma_rx_buf, DSI_BUF_SIZE);
