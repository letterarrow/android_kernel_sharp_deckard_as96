...
#ifdef CONFIG_SHLCDC_BOARD /* CUST_ID_00175 */
...
void mdp4_dtv_wait_unset_dmae(void);
#endif	/* CONFIG_SHLCDC_BOARD */
#else
...
#ifdef CONFIG_SHLCDC_BOARD /* CUST_ID_00176 */
static inline void mdp4_dtv_wait_unset_dmae(void)
{
    /* empty */
}
#endif	/* CONFIG_SHLCDC_BOARD */
...
#ifdef CONFIG_SHLCDC_BOARD /* CUST_ID_00007 */ /* CUST_ID_00008 */ /* CUST_ID_00010 */ /* CUST_ID_00011 */ /* CUST_ID_00012 */ /* CUST_ID_00013 */ /* CUST_ID_00022 */ /* CUST_ID_00029 */ /* CUST_ID_00044 */ /* CUST_ID_00083 */ /* CUST_ID_00169 */
int mdp4_vg_dither_setup(int vp_num);
int mdp4_vg_dither_disable(int vp_num);

int mdp4_vg_hist_lut_setup(int vp_num);
int mdp4_vg_hist_lut_update(struct msmfb_pipe_hist_lut_data *p, int user);
...
#define MDP4_AB_BW_LOWER_LIMIT 1025000000
#define MDP4_IB_BW_LOWER_LIMIT 1025000000
#elif defined(CONFIG_SHDISP_PANEL_GEMINI)
#define MDP4_AB_BW_LOWER_LIMIT 1067000000
#define MDP4_IB_BW_LOWER_LIMIT 1067000000
#endif
#endif /* MDP4_IB_BW_LOWER_LIMIT */
