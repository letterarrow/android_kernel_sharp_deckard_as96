/* drivers/video/msm/mipi_sharp_cmd_gemini_wuxga_pt.c  (Display Driver)
 *
...
static struct mipi_dsi_phy_ctrl dsi_cmd_mode_phy_db = {
    ...
    /* timing    */
    {0xFC, 0x4C, 0x40, 0x00, 0x89, 0x6E, 0x41, 0x4E, 0x47, 0x03, 0x04, 0x00},
    /* phy ctrl  */
    {0x7F, 0x00, 0x00, 0x10},
    /* strength  */
    {0xEE, 0x02, 0x86, 0x00},
    /* pll control */
    {0x00, 0x22, 0x31, 0xCF, 0x00, 0x50, 0x48, 0x63,
     0x30, 0x07, 0x01, /*  --> Four lane configuration */
     0x05, 0x14, 0x03, 0x00, 0x02, 0x54, 0x06, 0x10, 0x04, 0x00},
};

static int __init mipi_cmd_sharp_gemini_wuxga_pt_init(void)
{
    int ret;

    SHDISP_DEBUG("in\n");
    if (msm_fb_detect_client("mipi_cmd_sharp_gemini_wuxga")){
    ...
    pinfo.bl_min = 1;
    pinfo.fb_num = 2;
    pinfo.clk_rate = 982130000;
    pinfo.clk_min  = 982130000;
    pinfo.clk_max  = 982130000;
    pinfo.is_3d_panel = 0;
...
module_init(mipi_cmd_sharp_gemini_wuxga_pt_init);
