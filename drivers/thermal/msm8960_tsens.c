...
#define SHTSENS_ENABLE_DEVELOP_BUILD

#ifdef SHTSENS_ENABLE_DEVELOP_BUILD
#define TSENS_DEBUG_PORT_MAX (11)

static int debug_tsens_0_tmp = 0;
static int debug_tsens_1_tmp = 0;
static int debug_tsens_2_tmp = 0;
static int debug_tsens_3_tmp = 0;
static int debug_tsens_4_tmp = 0;
static int debug_tsens_5_tmp = 0;
static int debug_tsens_6_tmp = 0;
static int debug_tsens_7_tmp = 0;
static int debug_tsens_8_tmp = 0;
static int debug_tsens_9_tmp = 0;
static int debug_tsens_10_tmp = 0;

module_param_named(debug_tsens_0_tmp, debug_tsens_0_tmp, int, S_IRUSR | S_IWUSR );
module_param_named(debug_tsens_1_tmp, debug_tsens_1_tmp, int, S_IRUSR | S_IWUSR );
module_param_named(debug_tsens_2_tmp, debug_tsens_2_tmp, int, S_IRUSR | S_IWUSR );
module_param_named(debug_tsens_3_tmp, debug_tsens_3_tmp, int, S_IRUSR | S_IWUSR );
module_param_named(debug_tsens_4_tmp, debug_tsens_4_tmp, int, S_IRUSR | S_IWUSR );
module_param_named(debug_tsens_5_tmp, debug_tsens_5_tmp, int, S_IRUSR | S_IWUSR );
module_param_named(debug_tsens_6_tmp, debug_tsens_6_tmp, int, S_IRUSR | S_IWUSR );
module_param_named(debug_tsens_7_tmp, debug_tsens_7_tmp, int, S_IRUSR | S_IWUSR );
module_param_named(debug_tsens_8_tmp, debug_tsens_8_tmp, int, S_IRUSR | S_IWUSR );
module_param_named(debug_tsens_9_tmp, debug_tsens_9_tmp, int, S_IRUSR | S_IWUSR );
module_param_named(debug_tsens_10_tmp, debug_tsens_10_tmp, int, S_IRUSR | S_IWUSR );

static int * const debug_tsens_tmp_variable_table[TSENS_DEBUG_PORT_MAX] =
{
	& debug_tsens_0_tmp,
	& debug_tsens_1_tmp,
	& debug_tsens_2_tmp,
...
#ifdef SHTSENS_ENABLE_DEVELOP_BUILD
	int debug_tsens_tmp = 0;
	
	if( sensor_num >= 0 && sensor_num < TSENS_DEBUG_PORT_MAX )
	{
		debug_tsens_tmp = * debug_tsens_tmp_variable_table[sensor_num];
	}
	
	if(debug_tsens_tmp != 0)
	{
		*temp = debug_tsens_tmp;
		return;
	}
#endif
