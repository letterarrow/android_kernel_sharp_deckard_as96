...
#endif /* defined(CONFIG_CRADLE_SWIC) && !defined(CONFIG_CRADLE_DCIN_SH) */
...
static struct wake_lock shbatt_suspend_work_wake_lock;
#endif /* CONFIG_BATTERY_SH */
...
{
#ifdef CONFIG_BATTERY_SH
#ifdef CONFIG_PM_CHARGE_DIS_CONTROL
	if(shusb_softupdate_mode_flag) {
		disable = 0;
	}
#endif /* CONFIG_PM_CHARGE_DIS_CONTROL */
#endif /* CONFIG_BATTERY_SH */
...
#ifdef CONFIG_BATTERY_SH
int pm8921_charger_vddmax_get(int* voltage)
{
	if (!the_chip) {
		pr_err("called before init\n");
		return -EINVAL;
...
EXPORT_SYMBOL_GPL(pm8921_charger_vddmax_get);
#endif /* CONFIG_BATTERY_SH */
...
#ifdef CONFIG_BATTERY_SH
#define SHBATT_SUSPEND_WAKE_LOCK_TIMEOUT	1*HZ/2
#endif /* CONFIG_BATTERY_SH */
...
#ifdef CONFIG_BATTERY_SH
	if (!wake_lock_active(&shbatt_suspend_work_wake_lock))
	{
		wake_lock_timeout(&shbatt_suspend_work_wake_lock, SHBATT_SUSPEND_WAKE_LOCK_TIMEOUT);
	}
	else
	{
		wake_unlock(&shbatt_suspend_work_wake_lock);
		wake_lock_timeout(&shbatt_suspend_work_wake_lock, SHBATT_SUSPEND_WAKE_LOCK_TIMEOUT);
	}
#endif /* CONFIG_BATTERY_SH */
...
static void __devinit determine_initial_state(struct pm8921_chg_chip *chip)
{
	...
	pm8921_chg_disable_irq(chip, BATT_INSERTED_IRQ);
#endif /* CONFIG_SHSYS_CUST */
#ifdef CONFIG_BATTERY_SH
...
#ifdef CONFIG_PM_FAST_CHARGE_CONTROL
	#define SAFE_CURRENT_MA		1825
#else
	#define SAFE_CURRENT_MA		1500
#endif /* CONFIG_PM_FAST_CHARGE_CONTROL */
...
#ifdef CONFIG_BATTERY_SH
	if ((sh_boot_mode == SHBATT_BOOT_MODE_NORMAL) &&
		(!shusb_softupdate_mode_flag))
	{
...
#ifdef CONFIG_BATTERY_SH
	wake_lock_init(&shbatt_suspend_work_wake_lock, WAKE_LOCK_SUSPEND, "shbatt_suspend_work_wake_lock");
#endif /* CONFIG_BATTERY_SH */
...
#ifdef CONFIG_BATTERY_SH
	INIT_DELAYED_WORK(&chip->usbin_ov_check_work, usbin_ov_check_worker);
#endif /* CONFIG_BATTERY_SH */
