 ...
 *
 * $Id: dhd_linux.c 387243 2013-02-25 05:18:24Z $
 */
...
#if 0 /* [WLAN][SHARP] 2012.10.12 wifi eco mode Start */
extern int dhd_get_suspend_bcn_li_dtim(dhd_pub_t *dhd);
#else
extern int dhd_set_beacon_dtim_skip(dhd_pub_t *dhd, bool enable);
#endif /* [WLAN][SHARP] 2012.10.12 wifi eco mode End */
...
#endif /* DHDTHREAD */
/* Control fw roaming */
/* [WLAN][SHARP] 2011.10.11 Disable roaming Start */
#if 0
#ifdef BCMCCX
...
#endif
/* [WLAN][SHARP] 2011.10.11 Disable roaming End */
...
/* [WLAN][SHARP] 2011.01.20 Disable build path logging Start */
#if 0
#ifdef DHD_DEBUG
#ifndef SRCBASE
...
static char dhd_version[] = "Dongle Host Driver, version " EPI_VERSION_STR
#endif
/* [WLAN][SHARP] 2011.01.20 Disable build path logging End */
;
...
/* [WLAN][SHARP] 2011.04.11 Remedy for IEEE-PS problem End */
	...
	char iovbuf[32];
/* [WLAN][SHARP] 2012.10.12 wifi eco mode Start */
#if 0
	int bcn_li_dtim = 0; /* Default bcn_li_dtim in resume mode is 0 */
#endif
/* [WLAN][SHARP] 2012.10.12 wifi eco mode End */
/* [WLAN][SHARP] 2013.03.08 Enable ENABLE_FW_ROAM_SUSPEND(from 1.61.36) Start */
//#ifndef ENABLE_FW_ROAM_SUSPEND
#ifdef ENABLE_FW_ROAM_SUSPEND
/* [WLAN][SHARP] 2013.03.08 Enable ENABLE_FW_ROAM_SUSPEND(from 1.61.36) End */
	uint roamvar = 1;
...
#else
				dhd_set_beacon_dtim_skip(dhd, 1);
#endif
/* [WLAN][SHARP] 2012.10.12 wifi eco mode End */
/* [WLAN][SHARP] 2013.03.08 Enable ENABLE_FW_ROAM_SUSPEND(from 1.61.36) Start */
//#ifndef ENABLE_FW_ROAM_SUSPEND
...
/* [WLAN][SHARP] 2012.10.12 wifi eco mode Start */
				...
				dhd_wl_ioctl_cmd(dhd, WLC_SET_VAR, iovbuf, sizeof(iovbuf), TRUE, 0);
#else
				/* reset beacon/dtim skip setting */
				dhd_set_beacon_dtim_skip(dhd, 0);
#endif
/* [WLAN][SHARP] 2012.10.12 wifi eco mode End */
/* [WLAN][SHARP] 2013.03.08 Enable ENABLE_FW_ROAM_SUSPEND(from 1.61.36) Start */
//#ifndef ENABLE_FW_ROAM_SUSPEND
...
/* [WLAN][SHARP] 2012.02.13 always enable suspend Start */
#if 0
...
#endif
/* [WLAN][SHARP] 2012.02.13 always enable suspend End */
...
dhd_open(struct net_device *net)
{
	...
	/* [WLAN][SHARP] 2013.05.16 Suppress dhd_open execution in Wifi off sequence Start */
	if(dhd_loaded){
		DHD_ERROR(("%s: suppress unexpected dhd_open() calling \n", __FUNCTION__));
		return -1;
	}
...
/* [WLAN][SHARP] Customize Start
                 2011.02.21 Customize linkloss threshold, Customize default scan time settings Start
                 2011.03.11 For prevention of ProbeRequest lost.1->2
                 2011.10.11 Disable roaming
                 2012.11.12 Customize beacon timeout setting according to specification */

	int scan_nprobes = 2; /* For prevention of ProbeRequest */

#if 0 /* SHARP customize */
...
#else
#if defined(CONFIG_SHWLAN_BEACON_TIMEOUT) && (CONFIG_SHWLAN_BEACON_TIMEOUT != 0)
	uint bcn_timeout = CONFIG_SHWLAN_BEACON_TIMEOUT;
#else
	uint bcn_timeout = 10;
#endif /* SHWLAN_BEACON_TIMEOUT != 0 */
#endif /* SHARP customize */
...
#endif
/* [WLAN][SHARP] 2012.09.13 Disable short guard interval Start */
	uint sgi_rx = 0;
	uint sgi_tx = 0;
/* [WLAN][SHARP] 2012.09.13 Disable short guard interval End */
...
/* [WLAN][SHARP] 2013.01.08 Add for Static Link Start */
	op_mode = 0;
/* [WLAN][SHARP] 2013.01.08 Add for Static Link End */
...
/* [WLAN][SHARP] Customize End*/
#ifdef DISABLE_11AC
#if 0 /* [WLAN][SHARP] 2013.03.12 vht_mode set to 0 in STA/APSTA/P2P mode Start */
	bcm_mkiovar("vhtmode", (char *)&vhtmode, 4, iovbuf, sizeof(iovbuf));
	if ((ret = dhd_wl_ioctl_cmd(dhd, WLC_SET_VAR, iovbuf, sizeof(iovbuf), TRUE, 0)) < 0)
		DHD_ERROR(("%s wl vhtmode 0 failed %d\n", __FUNCTION__, ret));
#else
	if( strstr(fw_path, "_factory") == NULL ){
		bcm_mkiovar("vhtmode", (char *)&vhtmode, 4, iovbuf, sizeof(iovbuf));
		if ((ret = dhd_wl_ioctl_cmd(dhd, WLC_SET_VAR, iovbuf, sizeof(iovbuf), TRUE, 0)) < 0)
			DHD_ERROR(("%s wl vhtmode 0 failed %d\n", __FUNCTION__, ret));
	}
#endif /* [WLAN][SHARP] 2013.03.12 vht_mode set to 0 in STA/APSTA/P2P mode End */
#endif /* DISABLE_11AC */
...
/* [WLAN][SHARP] 2012.09.13 Disable short guard interval Start */
	bcm_mkiovar("sgi_rx", (char*)&sgi_rx, 4, buf, sizeof(buf));
	ret = dhd_wl_ioctl_cmd(dhd, WLC_SET_VAR, buf, sizeof(buf), TRUE, 0);
	if (ret < 0) {
		DHD_ERROR(("%s: can't set sgi_rx , error=%d\n", __FUNCTION__, ret));
		return BCME_NOTUP;
	}
	bcm_mkiovar("sgi_tx", (char*)&sgi_tx, 4, buf, sizeof(buf));
	ret = dhd_wl_ioctl_cmd(dhd, WLC_SET_VAR, buf, sizeof(buf), TRUE, 0);
	if (ret < 0) {
		DHD_ERROR(("%s: can't set sgi_tx , error=%d\n", __FUNCTION__, ret));
		return BCME_NOTUP;
	}
/* [WLAN][SHARP] 2012.09.13 Disable short guard interval End */
...
/* [WLAN][SHARP] 2011.02.26  For prevention of ProbeRequest lost Start */
	dhd_wl_ioctl_cmd(dhd, WLC_SET_SCAN_NPROBES, (char *)&scan_nprobes,
		sizeof(scan_nprobes), TRUE, 0);
/* [WLAN][SHARP] 2011.02.26  For prevention of ProbeRequest lost End */
...
/* [WLAN][SHARP] 2012.10.16 modification for problems when system suspend Start */
#if 0
...
#endif
/* [WLAN][SHARP] 2012.10.16 modification for problems when system suspend End */
/* [WLAN][SHARP] 2012.10.16 modification for problems when system suspend Start */
#if 0
...
/* [WLAN][SHARP] 2012.11.02 Customize for WiFi-Off Problem Start */
#if 0
	if (flag == TRUE) {
...
#endif	
/* [WLAN][SHARP] 2012.11.02 Customize for WiFi-Off Problem End */
