...
#define SHIRDA_GPIO_TXD		(10)
#define SHIRDA_GPIO_RXD		(11)
#define SHIRDA_GPIO_SD		(81)
#define SHIRDA_GPIO_TX_FUNC	(1)
#define SHIRDA_GPIO_RX_FUNC	(1)
...
#define GSBIREG_NO	(4)
#define GSBIREG_BASE		(0x16300000)
