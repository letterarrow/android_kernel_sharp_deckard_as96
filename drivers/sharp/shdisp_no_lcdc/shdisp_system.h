/* drivers/sharp/shdisp_no_lcdc/shdisp_system.h  (Display Driver)
 *
...
#define SHDISP_GPIO_NUM_LEDC_RST_N  PM8921_GPIO_PM_TO_SYS(15)
#else
#define SHDISP_GPIO_NUM_LEDC_RST_N  36
#endif
...
#define SHDISP_HW_REV_ES05      0x00            /* ES0.5 */
#define SHDISP_HW_REV_ES1       0x02            /* ES1   */
#define SHDISP_HW_REV_ES15      0x03            /* ES1.5 */
#define SHDISP_HW_REV_PP1       0x04            /* PP1   */
