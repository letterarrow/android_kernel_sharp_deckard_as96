/* drivers/sharp/shdisp_no_lcdc/shdisp_bl69y6.c  (Display Driver)
 *
...
#include "./data/shdisp_bl69y6_data_dl35.h"
...
static void shdisp_bdic_LD_TRI_LED_blink_on(unsigned char color, int ontime, int interval, int count);
static void shdisp_bdic_LD_TRI_LED_firefly_on(unsigned char color, int ontime, int interval, int count);
static void shdisp_bdic_LD_TRI_LED_high_speed_on(unsigned char color, int interval, int count);
static void shdisp_bdic_LD_TRI_LED_standard_on(unsigned char color, int interval, int count);
static void shdisp_bdic_LD_TRI_LED_breath_on(unsigned char color, int interval, int count);
static void shdisp_bdic_LD_TRI_LED_long_breath_on(unsigned char color, int interval, int count);
static void shdisp_bdic_LD_TRI_LED_wave_on(unsigned char color, int interval, int count);
static void shdisp_bdic_LD_TRI_LED_flash_on(unsigned char color, int interval, int count);
static void shdisp_bdic_LD_TRI_LED_aurora_on(int interval, int count);
static void shdisp_bdic_LD_TRI_LED_rainbow_on(int interval, int count);
...
int shdisp_bdic_API_boot_init( void )
{
    ...
    shdisp_SYS_set_Host_gpio(shdisp_api_get_bdic_reset_port(), SHDISP_GPIO_CTL_LOW);
    shdisp_SYS_delay_us(15000);
    shdisp_SYS_set_Host_gpio(shdisp_api_get_bdic_reset_port(), SHDISP_GPIO_CTL_HIGH);
...
unsigned char shdisp_bdic_API_TRI_LED_get_color_index_and_reedit(struct shdisp_tri_led *tri_led )
{
    ...
    for(idx=0; idx<SHDISP_TRI_LED_COLOR_TBL_NUM; idx ++) {
        if(( shdisp_triple_led_color_index_tbl[idx][0] == tri_led->red ) &&
           ( shdisp_triple_led_color_index_tbl[idx][1] == tri_led->green ) &&
           ( shdisp_triple_led_color_index_tbl[idx][2] == tri_led->blue )){
           color = (unsigned char)shdisp_triple_led_color_index_tbl[idx][3];
           break;
        }
    }
...
{
    shdisp_bdic_LD_TRI_LED_blink_on(color, ontime, interval, count);
...
{
    shdisp_bdic_LD_TRI_LED_firefly_on(color, ontime, interval, count);
...
{
    shdisp_bdic_LD_TRI_LED_high_speed_on(color, interval, count);
    return;
}
...
{
    shdisp_bdic_LD_TRI_LED_standard_on(color, interval, count);
    return;
}
...
{
    shdisp_bdic_LD_TRI_LED_breath_on(color, interval, count);
    return;
}
...
{
    shdisp_bdic_LD_TRI_LED_long_breath_on(color, interval, count);
    return;
}
...
{
    shdisp_bdic_LD_TRI_LED_wave_on(color, interval, count);
    return;
}
...
{
    shdisp_bdic_LD_TRI_LED_flash_on(color, interval, count);
    return;
}
...
{
    shdisp_bdic_LD_TRI_LED_aurora_on(interval, count);
    return;
}
...
{
    shdisp_bdic_LD_TRI_LED_rainbow_on(interval, count);
    return;
}
...
int  shdisp_bdic_API_PHOTO_SENSOR_lux_judge(void)
{
    ...
    if( s_state_str.bdic_main_bkl_opt_mode_output == SHDISP_BDIC_MAIN_BKL_OPT_LOW ){
        if(val >= s_state_str.shdisp_lux_change_level1 ){
            ...
            shdisp_bdic_IO_write_reg(BDIC_REG_ADOL, 0x40);
...
/* ------------------------------------------------------------------------- */
/* shdisp_bdic_LD_TRI_LED_high_speed_on                                      */
/* ------------------------------------------------------------------------- */
...
/* ------------------------------------------------------------------------- */
/* shdisp_bdic_LD_TRI_LED_standard_on                                        */
/* ------------------------------------------------------------------------- */
...
/* ------------------------------------------------------------------------- */
/* shdisp_bdic_LD_TRI_LED_breath_on                                          */
/* ------------------------------------------------------------------------- */
...
/* ------------------------------------------------------------------------- */
/* shdisp_bdic_LD_TRI_LED_long_breath_on                                     */
/* ------------------------------------------------------------------------- */
...
/* ------------------------------------------------------------------------- */
/* shdisp_bdic_LD_TRI_LED_wave_on                                            */
/* ------------------------------------------------------------------------- */
...
/* ------------------------------------------------------------------------- */
/* shdisp_bdic_LD_TRI_LED_flash_on                                           */
/* ------------------------------------------------------------------------- */
...
/* ------------------------------------------------------------------------- */
/* shdisp_bdic_LD_TRI_LED_aurora_on                                          */
/* ------------------------------------------------------------------------- */
...
/* ------------------------------------------------------------------------- */
/* shdisp_bdic_LD_TRI_LED_rainbow_on                                         */
/* ------------------------------------------------------------------------- */
...
static void shdisp_bdic_PD_TRI_LED_set_chdig(void)
{
    ...
    if( shdisp_bdic_tri_led_mode != SHDISP_BDIC_TRI_LED_MODE_NORMAL) {
        shdisp_bdic_IO_clr_bit_reg(BDIC_REG_CH0_SET1, 0x20);
        shdisp_bdic_IO_clr_bit_reg(BDIC_REG_CH1_SET1, 0x20);
        shdisp_bdic_IO_clr_bit_reg(BDIC_REG_CH2_SET1, 0x20);
        shdisp_bdic_IO_clr_bit_reg(BDIC_REG_TIMEER1, 0xF0);
        shdisp_bdic_IO_set_bit_reg(BDIC_REG_LPOSC, 0x01);
        shdisp_SYS_delay_us(32000);
    }
