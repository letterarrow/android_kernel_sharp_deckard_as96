/* drivers/sharp/shdisp_no_lcdc/shdisp_type.h  (Display Driver)
 *
...
enum {
    SHDISP_DEBUG_FUNCTION,
    SHDISP_DEBUG_KERNEL,
    NUM_SHDISP_DEBUG_CATEGORY
};
enum {
    SHDISP_DEBUG_PROCESS_STATE_OUTPUT,
    SHDISP_DEBUG_TRACE_LOG_SWITCH,
    NUM_SHDISP_DEBUG_FUNCTION
};
enum {
    SHDISP_DEBUG_LCD_DISP_CTL,
    SHDISP_DEBUG_BKL_CTL,
    SHDISP_DEBUG_BDIC_I2C_WRITE,
    SHDISP_DEBUG_BDIC_I2C_READ,
    SHDISP_DEBUG_PROX_SENSOR_CTL,
    SHDISP_DEBUG_IRQ_LOGIC_CHK,
    SHDISP_DEBUG_BDIC_IRQ_ALL_CLEAR,
    SHDISP_DEBUG_BDIC_IRQ_CLEAR,
    SHDISP_DEBUG_DUMMY_SUBSCRIBE,
    SHDISP_DEBUG_DUMMY_UNSUBSCRIBE_PS,
    SHDISP_DEBUG_DUMMY_UNSUBSCRIBE_ALS,
    SHDISP_DEBUG_LUX_REGISTER_CHANGE,
    SHDISP_DEBUG_XEN_SENSOR_CLEAR_WAIT_TIME,
    SHDISP_DEBUG_XEN_SENSOR_BIT_CLEAR,
    SHDISP_DEBUG_CHECK_BLACKSCREEN_TIMEOUT,
    NUM_SHDISP_DEBUG_KERNEL
};
