...
#define TSPDRV_OUTDATA_FUNC_LOG(fmt, args...) \
	if( tspdrv_func_log == 1 ){ \
		printk( KERN_DEBUG "[TSPDRV][tspdrvOutputDataHandler.c][%d][%s]" fmt "\n", __LINE__, __func__, ## args ); \
	}
