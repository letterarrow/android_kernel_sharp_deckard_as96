...
extern int arizona_headset_bu_state(void);
extern int arizona_codec_set_bias_mode(int mode);
#else
...
#ifdef CONFIG_SWITCH_ARIZONA
	state.hp_state = arizona_headset_hp_state();
	state.button_state = arizona_headset_bu_state();
#else
...
#ifdef CONFIG_SWITCH_ARIZONA /* 03-011 */
    arizona_codec_set_bias_mode(mode);
#else
	tabla_codec_set_bias_mode(mode);
#endif /* CONFIG_SWITCH_ARIZONA */
	return 0;
}
#endif /* CONFIG_SH_AUDIO_DRIVER */ /* 03-011 */
