...
/* Additional DAIs for SlimBus */
#define ARIZONA_MAX_DAI  10
#define ARIZONA_MAX_ADSP 4

#define ARIZONA_SLIMRX1 4
#define ARIZONA_SLIMRX2 5
#define ARIZONA_SLIMRX3 6
#define ARIZONA_SLIMTX1 7
#define ARIZONA_SLIMTX2 8
#define ARIZONA_SLIMTX3 9
...
#define ARIZONA_NUM_MIXER_INPUTS 69
