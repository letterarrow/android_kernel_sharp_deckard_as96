...
#ifdef CONFIG_SH_AUDIO_DRIVER /*03-009*/
#define PM8921_IRQ_BASE (NR_MSM_IRQS + NR_GPIO_IRQS)
#endif /* CONFIG_SH_AUDIO_DRIVER */ /*03-009*/
...
#ifndef CONFIG_SH_AUDIO_DRIVER /*03-004*/
/* SP-AMP control     */
...
/* [BatteryTemperatureLog] [end] */ /* 03-037 */
#else /* CONFIG_SH_AUDIO_DRIVER */ /*03-004*/
...
static int msm_receiver_event(struct snd_soc_dapm_widget *w,
	struct snd_kcontrol *k, int event)
{
	pr_debug("%s: %x\n", __func__, SND_SOC_DAPM_EVENT_ON(event));
...
#ifdef CONFIG_SHRECEIVER_LM48560
/* Bone Conduction Receiver control */
	SND_SOC_DAPM_SPK("Ext Receiver SHRECEIVER", msm_receiver_event),
#endif /* CONFIG_SHRECEIVER_LM48560 */
#endif /* CONFIG_SH_AUDIO_DRIVER */ /*03-012*/
...
#ifdef CONFIG_SH_AUDIO_DRIVER /* 03-002 */
...
#ifdef CONFIG_SH_AUDIO_DRIVER /*03-071*/
	S(v_no_mic, 200);
#else /* CONFIG_SH_AUDIO_DRIVER */
	S(v_no_mic, 30);
