...
static struct clk_freq_tbl clk_tbl_gsbi_qup[] = {
	...
	F_GSBI_QUP(38400000, pll8, 1, 5, 50),
...
static struct clk_freq_tbl clk_tbl_cam[] = {
	...
	#if defined(CONFIG_IMX081) || defined(CONFIG_IMX091) || defined(CONFIG_IMX135) || defined(CONFIG_IMX132) || defined(CONFIG_IMX111)
	F_CAM(  6750000, pxo,  4, 0,  0),
	#endif /* defined(CONFIG_IMX081) || defined(CONFIG_IMX091) */
...
#if defined(CONFIG_MFD_WM5102) && defined(CONFIG_SH_AUDIO_DRIVER) /*03-113*/
		.halt_check = NOCHECK,
#else  /* CONFIG_MFD_WM5102 && CONFIG_SH_AUDIO_DRIVER */ /*03-113*/
		.halt_check = ENABLE,
#endif /* CONFIG_MFD_WM5102 && CONFIG_SH_AUDIO_DRIVER */ /*03-113*/
		.halt_bit = 0,
	},
...
static struct clk_lookup msm_clocks_8064[] = {
...
#else	/* CONFIG_SERIAL_MSM_HSL_CONSOLE */
	...
	CLK_LOOKUP("core_clk",		gsbi3_qup_clk.c,	"spi_qsd.1"),
#else	/* defined(CONFIG_SHSYS_CUST) */
	...
	CLK_LOOKUP("iface_clk",		gsbi3_p_clk.c,		"spi_qsd.1"),
#else	/* defined(CONFIG_SHSYS_CUST) */
...
#endif	/* CONFIG_SERIAL_BLUETOOTH */
#if	defined(CONFIG_SHSYS_CUST)
    CLK_LOOKUP("iface_clk",		gsbi6_p_clk.c, "spi_qsd.2"),
#else	/* defined(CONFIG_SHSYS_CUST) */
