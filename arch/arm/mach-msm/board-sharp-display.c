/* arch/arm/mach-msm/board-sharp-display.c (Display Driver)
 *
...
#include "board-8064.h"
...
#ifdef CONFIG_SHLCDC_BOARD /* CUST_ID_00091 */
  #if (defined(CONFIG_MACH_LYNX_DL32) || defined(CONFIG_MACH_TDN)) && defined(CONFIG_USES_SHLCDC)
    #define PANEL_WIDTH  1080
    #define PANEL_HEIGHT 1920
    #define PANEL_WIDTH_ALIG  1088
    #define PANEL_HEIGHT_ALIG 1920
  #elif defined(CONFIG_MACH_LYNX_GP6D) && defined(CONFIG_USES_SHLCDC)
    #if defined(CONFIG_SHDISP_PANEL_GEMINI)
      #define PANEL_WIDTH  1200
      #define PANEL_HEIGHT 1920
      #define PANEL_WIDTH_ALIG  1216
      #define PANEL_HEIGHT_ALIG 1920
    ...
    #define PANEL_WIDTH_ALIG  736
    #define PANEL_HEIGHT_ALIG 1280
  #endif
...
#ifdef CONFIG_SHLCDC_BOARD /* CUST_ID_00065 */
#define MSM_FB_SIZE roundup((roundup((PANEL_WIDTH_ALIG * PANEL_HEIGHT_ALIG * 4), 4096) * 3), 4096)
#else  /* CONFIG_SHLCDC_BOARD */
#define MSM_FB_SIZE roundup(MSM_FB_PRIM_BUF_SIZE, 4096)
#endif /* CONFIG_SHLCDC_BOARD */

#ifdef CONFIG_FB_MSM_OVERLAY0_WRITEBACK
#ifdef CONFIG_SHLCDC_BOARD /* CUST_ID_00072 */
#define MSM_FB_OVERLAY0_WRITEBACK_SIZE roundup((PANEL_HEIGHT * PANEL_WIDTH * 3 * 2), 4096)
#else  /* CONFIG_SHLCDC_BOARD */
...
#define MSM_FB_OVERLAY1_WRITEBACK_SIZE roundup((PANEL_HEIGHT_ALIG * PANEL_WIDTH_ALIG * 3 * 2), 4096)
#else
...
#define MIPI_CMD_SHARP_ANDY_FHD_PANEL_NAME  "mipi_cmd_sharp_andy_fhd"
#define MIPI_CMD_SHARP_MARCO_FHD_PANEL_NAME  "mipi_cmd_sharp_marco_fhd"
#define MIPI_CMD_SHARP_GEMINI_WUXGA_PANEL_NAME  "mipi_cmd_sharp_gemini_wuxga"
#endif /* CONFIG_SHLCDC_BOARD */
...
#ifdef CONFIG_FB_MSM_MIPI_SHARP_ANDY_CMD_FHD_PT
	if (!strncmp(name, MIPI_CMD_SHARP_ANDY_FHD_PANEL_NAME,
			strnlen(MIPI_CMD_SHARP_ANDY_FHD_PANEL_NAME,
				PANEL_NAME_MAX_LEN)))
		return 0;
#endif /* CONFIG_FB_MSM_MIPI_SHARP_ANDY_CMD_FHD_PT */
#ifdef CONFIG_FB_MSM_MIPI_SHARP_MARCO_CMD_FHD_PT
	if (!strncmp(name, MIPI_CMD_SHARP_MARCO_FHD_PANEL_NAME,
			strnlen(MIPI_CMD_SHARP_MARCO_FHD_PANEL_NAME,
				PANEL_NAME_MAX_LEN)))
		return 0;
#endif /* CONFIG_FB_MSM_MIPI_SHARP_MARCO_CMD_FHD_PT */
#ifdef CONFIG_FB_MSM_MIPI_SHARP_GEMINI_CMD_WUXGA_PT
	if (!strncmp(name, MIPI_CMD_SHARP_GEMINI_WUXGA_PANEL_NAME,
			strnlen(MIPI_CMD_SHARP_GEMINI_WUXGA_PANEL_NAME,
				PANEL_NAME_MAX_LEN)))
		return 0;
#endif /* CONFIG_FB_MSM_MIPI_SHARP_GEMINI_CMD_WUXGA_PT */
...
#elif defined(CONFIG_MACH_LYNX_DL32) && defined(CONFIG_USES_SHLCDC)
static struct mipi_dsi_panel_platform_data mipi_sharp_pdata = {
	.width_in_mm = 60,
	.height_in_mm = 106,
};
...
static struct mipi_dsi_panel_platform_data mipi_sharp_pdata = {
  ...
  #endif /* CONFIG_SHDISP_PANEL_GEMINI */
#elif defined(CONFIG_MACH_DECKARD_AS96) && defined(CONFIG_USES_SHLCDC)
static struct mipi_dsi_panel_platform_data mipi_sharp_pdata = {
	.width_in_mm = 60,
	.height_in_mm = 108,
};
#elif defined(CONFIG_MACH_TDN) && defined(CONFIG_USES_SHLCDC)
static struct mipi_dsi_panel_platform_data mipi_sharp_pdata = {
	.width_in_mm = 62,
	.height_in_mm = 110,
};
