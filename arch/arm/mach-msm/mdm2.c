...
#if	defined(CONFIG_SHSYS_CUST) && defined(CONFIG_SHBOOT_CUST)
#include <sharp/sh_boot_manager.h>
#endif	/*defined(CONFIG_SHSYS_CUST) && defined(CONFIG_SHBOOT_CUST)*/
...
#if	defined(CONFIG_SHSYS_CUST)
	if (soft_reset_direction_de_assert == 1) {
		mdelay(50);
...
#endif /*defined(CONFIG_SHBOOT_CUST)*/
	int gpio_value;
	gpio_value = gpio_get_value(mdm_drv->mdm2ap_status_gpio);
