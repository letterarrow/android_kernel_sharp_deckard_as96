...
VREG_CONSUMERS(L2) = {
	...
	REGULATOR_SUPPLY("clmr_vdd_12lp",	NULL),
...
VREG_CONSUMERS(L8) = {
	...
	REGULATOR_SUPPLY("cam_vana",		"0-006c"),
	REGULATOR_SUPPLY("cam_vana",		"0-0078"),
};
VREG_CONSUMERS(L9) = {
...
VREG_CONSUMERS(L11) = {
	...
	REGULATOR_SUPPLY("cam_avdd",		"0-0020"),
	REGULATOR_SUPPLY("cam_vana",		"0-0034"), 
};
VREG_CONSUMERS(L12) = {
	...
	REGULATOR_SUPPLY("cam_vdig",		"0-0078"),
	REGULATOR_SUPPLY("8921_l12",		NULL),
#ifdef CONFIG_USES_SHLCDC
	REGULATOR_SUPPLY("clmr_vdd_core",	NULL),
#endif /* CONFIG_USES_SHLCDC */
};
VREG_CONSUMERS(L13) = {
...
VREG_CONSUMERS(L16) = {
	...
	REGULATOR_SUPPLY("cam_vaf",		"0-0020"),
	REGULATOR_SUPPLY("cam_vaf",		"0-0034"),
};
VREG_CONSUMERS(L17) = {
...
#ifdef CONFIG_USES_SHLCDC
	REGULATOR_SUPPLY("clmr_vdd_pll",	NULL),
#endif /* CONFIG_USES_SHLCDC */
};
VREG_CONSUMERS(L22) = {
...
VREG_CONSUMERS(L28) = {
	...
	REGULATOR_SUPPLY("cam_vdig2",		"0-0020"),
};
VREG_CONSUMERS(L29) = {
	REGULATOR_SUPPLY("8921_l29",		NULL),
	REGULATOR_SUPPLY("cam_vio2",	"0-0078"),
};
VREG_CONSUMERS(S2) = {
...
#ifdef CONFIG_USES_SHLCDC
	REGULATOR_SUPPLY("clmr_vdd",	NULL),
#endif

#ifdef CONFIG_SH_AUDIO_DRIVER
#if	defined(CONFIG_MFD_WM5102)
	REGULATOR_SUPPLY("AVDD",		"wm5102"),
	REGULATOR_SUPPLY("DBVDD1",		"wm5102"),
...
VREG_CONSUMERS(S8) = {
    ...
    REGULATOR_SUPPLY("lcd_vddi",    NULL),
};
VREG_CONSUMERS(LVS1) = {
...
VREG_CONSUMERS(LVS5) = {
	...
	REGULATOR_SUPPLY("cam_vio",		"0-0020"),
	REGULATOR_SUPPLY("cam_vio",		"0-006c"),
	REGULATOR_SUPPLY("cam_vio",		"0-0078"),
	REGULATOR_SUPPLY("cam_vio",		"0-0034"),
#ifdef CONFIG_USES_SHLCDC
    REGULATOR_SUPPLY("clmr_vdd_18rx",	NULL),
#endif
};
VREG_CONSUMERS(LVS6) = {
...
VREG_CONSUMERS(LVS2) = {
	...
	REGULATOR_SUPPLY("cam_vdig2",		"0-006c"),
	REGULATOR_SUPPLY("cam_vdig",		"0-0034"), 
};
...
apq8064_rpm_regulator_init_data[] __devinitdata = {
...
#else  /* CONFIG_BATTERY_SH */
	RPM_SMPS(S3, 1, 1, 1,  500000, 1400000, NULL, 100000, 4p80, NONE, NONE),
	RPM_SMPS(S4, 1, 1, 0, 1800000, 1800000, NULL, 100000, 1p60, AUTO, AUTO),
	RPM_SMPS(S7, 0, 0, 0, 1150000, 1150000, NULL, 100000, 3p20, NONE, NONE),
	RPM_SMPS(S8, 0, 0, 0, 1850000, 1850000, NULL, 100000, 1p60, NONE, NONE),
#endif /* CONFIG_BATTERY_SH */
	...
	RPM_LDO(L2,  0, 1, 0, 1200000, 1200000, "8921_s4",     0,     0),
	RPM_LDO(L3,  1, 1, 0, 3075000, 3075000, NULL,          0,     0),
	RPM_LDO(L4,  1, 1, 0, 1800000, 1800000, NULL,          0, 10000),
	RPM_LDO(L5,  1, 1, 0, 2950000, 2950000, NULL,          0,     0),
	RPM_LDO(L6,  0, 1, 0, 2800000, 2800000, NULL,          0,     0),
	RPM_LDO(L7,  0, 1, 0, 1850000, 2950000, NULL,          0,     0),
	RPM_LDO(L8,  0, 1, 0, 2800000, 2800000, NULL,          0,     0),
...
#if defined(CONFIG_PM_REG_CALIMERO)
	RPM_LDO(L12, 0, 1, 0, 1100000, 1100000, "8921_s4",     0,     0),
#else
	RPM_LDO(L12, 0, 1, 0, 1225000, 1225000, "8921_s4",     0,     0),
#endif
	RPM_LDO(L13, 0, 0, 0, 2220000, 2220000, NULL,          0,     0),
	RPM_LDO(L14, 0, 1, 0, 1800000, 1800000, NULL,          0,     0),
#if defined(CONFIG_PM_REG_CTS_SENSOR)
	RPM_LDO(L15, 1, 1, 0, 3300000, 3300000, NULL,          0,     0),
#else
	RPM_LDO(L15, 1, 1, 0, 2850000, 2850000, NULL,          0,     0),
#endif
	RPM_LDO(L16, 0, 1, 0, 3000000, 3000000, NULL,          0,     0),
#if defined(CONFIG_PM_REG_WIRELESS)
	RPM_LDO(L17, 0, 0, 0, 3000000, 3000000, NULL,          0,     0),
#elif defined(CONFIG_PM_REG_HDQ)
	RPM_LDO(L17, 1, 1, 0, 3000000, 3000000, NULL,          0,     0),
#else
	RPM_LDO(L17, 0, 1, 0, 2000000, 2000000, NULL,          0,     0),
#endif
#if defined(CONFIG_PM_REG_DTV)
	RPM_LDO(L18, 0, 1, 0, 1200000, 1200000, "8921_s4",     0,     0),
#else
	RPM_LDO(L18, 0, 1, 0, 1100000, 1100000, "8921_s4",     0,     0),
#endif
#if defined(CONFIG_PM_REG_WALFSON)
	RPM_LDO(L21, 1, 1, 0, 1800000, 1800000, NULL,          0,     0),
#elif defined(CONFIG_PM_REG_WCD9310)
	...
	RPM_LDO(L28, 0, 1, 0, 1100000, 1100000, "8921_s1",     0,     0),
...
#ifdef CONFIG_BATTERY_SH
void __init apq8064_pm8921_regulator_init(void)
{
}
#endif /* CONFIG_BATTERY_SH */
