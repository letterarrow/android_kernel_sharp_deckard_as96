...
struct platform_device apq8064_device_qup_spi_gsbi3 = {
	.name		= "spi_qsd",
	.id		= 1,
...
struct platform_device apq8064_device_qup_spi_gsbi6 = {
	.name		= "spi_qsd",
	.id		= 2,
...
static u64 msm_uart_gsbi4_dma_mask = DMA_BIT_MASK(32);
...
struct platform_device apq8064_device_uart_gsbi4 = {
	...
	.id	= SHIRDA_UARTDM_ID,
	.dev	= {
		.dma_mask = &msm_uart_gsbi4_dma_mask,
		.coherent_dma_mask = DMA_BIT_MASK(32),
		.platform_data = NULL,
	},
};
...
#endif	/* defined(CONFIG_SERIAL_BLUETOOTH) */
