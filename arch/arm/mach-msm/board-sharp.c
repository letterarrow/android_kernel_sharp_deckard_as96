...
#ifdef CONFIG_SH_AUDIO_DRIVER /*03-012*/
/* SP-AMP control     */
#include <sharp/shspamp.h>
#endif /* CONFIG_SH_AUDIO_DRIVER */ /*03-012*/
...
#if defined(CONFIG_MACH_LYNX_GP6D) || defined(CONFIG_MACH_TDN)
#define MSM_ION_MM_SIZE     0x8000000
#else
#define MSM_ION_MM_SIZE     0x3800000
#endif /* defined(CONFIG_MACH_LYNX_GP6D) || defined(CONFIG_MACH_TDN) */
...
static struct msm_otg_platform_data msm_otg_pdata = {
	...
	defined(CONFIG_MACH_LYNX_DL32) || \
	defined(CONFIG_MACH_LYNX_DL35) || \
	defined(CONFIG_MACH_LYNX_GP6D) || \
	defined(CONFIG_MACH_TDN)
	.power_budget       = 500,
#else
	.power_budget       = 100,
#endif
...
static struct i2c_board_info shbatt_wlchg_info_gsbi2[] __initdata = {
    {
        I2C_BOARD_INFO("wlchg_i2c_gsbi2", (0x52 >> 1)),
    },
};
static struct i2c_board_info shbatt_wlchg_info_gsbi1[] __initdata = {
    {
        I2C_BOARD_INFO("wlchg_i2c_gsbi1", (0x52 >> 1)),
    },
};
#endif	/* CONFIG_PM_WIRELESS_CHARGE_IC_ACCESS_I2C */

#ifdef CONFIG_SHVIBRATOR_LINEAR
static struct i2c_board_info msm_vib_board_info[] __initdata = {
	{
...
#if	defined(CONFIG_SH_GSBI1_I2C)
static struct platform_device *common_not_mpq_devices_gsbi1[] __initdata = {
	&apq8064_device_qup_i2c_gsbi1,
};
#endif	/* defined(CONFIG_SH_GSBI1_I2C) */
...
#if	defined(CONFIG_SH_GSBI7_I2C)
static struct platform_device *common_not_mpq_devices_gsbi7[] __initdata = {
	&apq8064_device_qup_i2c_gsbi7,
};
#endif	/* defined(CONFIG_SH_GSBI7_I2C) */

static struct platform_device *early_common_devices[] __initdata = {
	&apq8064_device_acpuclk,
	&apq8064_device_dmov,
#if	defined(CONFIG_SHSYS_CUST)
	&apq8064_device_qup_spi_gsbi3,
#else	/* defined(CONFIG_SHSYS_CUST) */
...
#if	defined(CONFIG_SHSYS_CUST)
static struct platform_device *early_common_devices_calimero[] __initdata = {
	&apq8064_device_qup_spi_gsbi6,
};
#endif	/* defined(CONFIG_SHSYS_CUST) */
...
#if	defined(CONFIG_SHSYS_CUST)
static struct msm_spi_platform_data apq8064_qup_spi_gsbi3_pdata = {
...
#if	defined(CONFIG_SHSYS_CUST)
static struct msm_spi_platform_data apq8064_qup_spi_gsbi6_pdata = {
    #if !defined(CONFIG_USES_SHLCDC)
    .max_clock_speed = 1100000,
    #else
...
static int msm_shtps_gpio_setup(struct device *dev)
{
    ...
    rc = gpio_request(SHTPS_SY3X00_GPIO_IRQ, "shtps_irq");
    if (rc) {
        pr_err("%s() request gpio failed (irq)\n", __func__);
        return rc;
    }

    rc = gpio_request(PM8921_GPIO_PM_TO_SYS(SHTPS_SY3X00_GPIO_RST), "shtps_rst");
    if (rc) {
        pr_err("%s() request gpio failed (rst)\n", __func__);
        return rc;
    }
    pm8xxx_gpio_config(PM8921_GPIO_PM_TO_SYS(SHTPS_SY3X00_GPIO_RST), &param);
...
static void msm_shtps_gpio_teardown(struct device *dev)
{
    ...
    gpio_free(PM8921_GPIO_PM_TO_SYS(SHTPS_SY3X00_GPIO_RST));
}

static struct shtps_platform_data shtps_pdata = {
    .setup    = msm_shtps_gpio_setup,
    .teardown = msm_shtps_gpio_teardown,
    .gpio_rst = PM8921_GPIO_PM_TO_SYS(SHTPS_SY3X00_GPIO_RST),
};
...
#ifdef CONFIG_SH_AUDIO_DRIVER /*03-001*/
#if	defined(CONFIG_MFD_WM5102)
static struct arizona_micd_config wm5102_micd_configs = {
	.src  = 0,
	.bias = 1 << ARIZONA_MICD_BIAS_SRC_SHIFT,
	.gpio = 0,
};

static struct regulator_consumer_supply wm5102_micvdd_supply[] =
{
	[0] = { .dev_name = "wm5102"      , .supply = "MICVDD", },
	[1] = { .dev_name = "wm5102-codec", .supply = "MICVDD", },
};
static struct regulator_init_data wm5102_micsupp = {
	.constraints = {
	...
	.consumer_supplies = wm5102_micvdd_supply,
	.num_consumer_supplies = ARRAY_SIZE(wm5102_micvdd_supply),
};

static struct arizona_pdata wm5102_pdata = {
	.reset = PM8921_GPIO_PM_TO_SYS(34),
	.ldoena = PM8921_GPIO_PM_TO_SYS(4),
	.irq_base = TABLA_INTERRUPT_BASE,
	.control_init_time = 10,
	.gpio_defaults = {
		[0] = 0x2001,
		[1] = 0x0001,
		[2] = 0x0005,
	},
	.micd_configs= &wm5102_micd_configs,
	.num_micd_configs = 1,
	...
	.micd_rate = 6,
	.micvdd = &wm5102_micsupp,
};

static struct slim_device wm5102_slimbus = {
	.name = "wm5102",
	.e_addr = { 0x00, 0x7f, 0x02, 0x51, 0x2f, 0x01 },
	.dev = {
...
#if defined(CONFIG_MFD_WM5102) && defined(CONFIG_SH_AUDIO_DRIVER) /*03-001*/
	{
		.bus_num = 1,
		.slim_slave = &wm5102_slimbus,
	},
...
#endif /* CONFIG_MFD_WM5102 && CONFIG_SH_AUDIO_DRIVER */ /*03-001*/
...
static struct msm_i2c_platform_data apq8064_i2c_qup_gsbi1_pdata = {
	...
	.clk_freq = 384000,
#else	/* defined(CONFIG_I2C_CUST_SH) */
	.clk_freq = 100000,
...
#define	GSBI7_3D_CAM_CTL_WACR				0x008003e8
#define	GSBI7_3D_CAM_CTL_RWGE_BIT			0x00000200
#define	GSBI7_3D_CAM_CTL					0x008020bc
#define	GSBI7_3D_CAM_CTL_ENABLE_LEFT_I2C	0x00000002
...
static void __init apq8064_i2c_init(void)
{
...
#else	/* !defined(CONFIG_SHSYS_CUST) */
#if	defined(CONFIG_SHIRDA) || defined(CONFIG_SHFELICA) || defined(CONFIG_SERIAL_MSM_HSL_CONSOLE) || defined(CONFIG_SH_GSBI7_I2C)
	void __iomem *gsbi_mem;
#endif	/* defined(CONFIG_SHIRDA) || defined(CONFIG_SHFELICA) || defined(CONFIG_SERIAL_MSM_HSL_CONSOLE) || defined(CONFIG_SH_GSBI7_I2C) */
	...
	{
		unsigned int v;
		gsbi_mem = ioremap_nocache(GSBI7_3D_CAM_CTL_WACR, 4);
		v = readl_relaxed(gsbi_mem);
		writel_relaxed(v | GSBI7_3D_CAM_CTL_RWGE_BIT, gsbi_mem);
		iounmap(gsbi_mem);

		gsbi_mem = ioremap_nocache(GSBI7_3D_CAM_CTL, 4);
		writel_relaxed(GSBI7_3D_CAM_CTL_ENABLE_LEFT_I2C, gsbi_mem);
		iounmap(gsbi_mem);
	}
#endif	/* defined(CONFIG_SH_GSBI7_I2C) */
...
#else /* #ifndef CONFIG_KEYBOARD_SCKEY */
#if ( CONFIG_KEYPAD_TYPE == 0x1001 )
static struct gpio_keys_button sh_gpio_keys[] = {
	{
		.code           = KEY_APP1,
		.gpio           = PM8921_GPIO_PM_TO_SYS(1),
		.desc           = "application_key",
		.active_low     = 1,
		.type		= EV_KEY,
		.wakeup		= 1,
		.debounce_interval = 15,
...
#endif /* ( CONFIG_KEYPAD_TYPE == 0x1001 ) */

static struct gpio_keys_platform_data sh_gpio_keys_data = {
	.buttons        = sh_gpio_keys,
	.nbuttons       = ARRAY_SIZE(sh_gpio_keys),
};

static struct platform_device sh_gpio_keys_pdev = {
	.name           = "SH_gpio-keys",
	.id             = -1,
	.dev            = {
		.platform_data  = &sh_gpio_keys_data,
	},
};
...
static struct shreceiver_platform_data shreceiver_data = {
    .gpio_shreceiver_receiver_en = PM8921_GPIO_PM_TO_SYS(16),
};
...
#define NFC_GPIO_IRQ            26
#define NFC_GPIO_FIRM           2
...
static struct i2c_board_info i2c_bcm2079x[] __initdata = {
	{
		I2C_BOARD_INFO("bcm2079x-i2c", 0xEE >> 1),
...
static struct i2c_board_info shtmp_sensor_i2c_info[] __initdata = {
	{
		I2C_BOARD_INFO("shtmp_i2c", 0xE0 >> 1 ),
	}
};
...
#ifdef CONFIG_SHFMTX_SI4710
/* FMTX_si4710 control */
static struct shfmtx_platform_data shfmtx_si4710_data = {
 .shfmtx_gpio_reset = PM8921_GPIO_PM_TO_SYS(11),
};

static struct i2c_board_info shfmtx_si4710_board_info[] __initdata = {
 {
  I2C_BOARD_INFO("shfmtx_i2c", 0x22 >> 1),
  .platform_data = &shfmtx_si4710_data,
 }
};
#endif /* CONFIG_SHFMTX_SI4710 */

#ifdef CONFIG_CAPACITIVE_TOUCH_SENSOR_SHCTS
static struct i2c_board_info shcts_i2c_board_info[] __initdata = {
	{
		I2C_BOARD_INFO(SHCTS_DEVNAME, (0x50 >> 1)),
	}
};
#endif /* CONFIG_CAPACITIVE_TOUCH_SENSOR_SHCTS */
...
/* Bone Conduction Receiver control */
...
#ifdef CONFIG_SHTMP_SENSOR
    {
        ...
        shtmp_sensor_i2c_info,
        ARRAY_SIZE(shtmp_sensor_i2c_info),
    },
#endif /* CONFIG_SHTMP_SENSOR */
#ifdef CONFIG_PM_WIRELESS_CHARGE_IC_ACCESS_I2C
    {
        I2C_SURF | I2C_FFA | I2C_LIQUID | I2C_RUMI,
        APQ_8064_GSBI2_QUP_I2C_BUS_ID,
        shbatt_wlchg_info_gsbi2,
        ARRAY_SIZE(shbatt_wlchg_info_gsbi2),
    },
    {
        I2C_SURF | I2C_FFA | I2C_LIQUID | I2C_RUMI,
        APQ_8064_GSBI1_QUP_I2C_BUS_ID,
        shbatt_wlchg_info_gsbi1,
        ARRAY_SIZE(shbatt_wlchg_info_gsbi1),
    },
#endif	/* CONFIG_PM_WIRELESS_CHARGE_IC_ACCESS_I2C */
#endif /* CONFIG_BATTERY_SH */
#ifdef CONFIG_SHMDS
...
#ifdef CONFIG_SENSORS_WTAP
    {
        ...
        APQ_8064_GSBI2_QUP_I2C_BUS_ID,
        msm_wtap_board_info,
        ARRAY_SIZE(msm_wtap_board_info),
    },
#endif /* CONFIG_SENSORS_WTAP */
...
/* FMTX_si4710 control */
    {
        I2C_SURF | I2C_FFA | I2C_LIQUID | I2C_RUMI,
        APQ_8064_GSBI4_QUP_I2C_BUS_ID,
        shfmtx_si4710_board_info,
        ARRAY_SIZE(shfmtx_si4710_board_info),
    },
#endif /* CONFIG_SHFMTX_SI4710 */
#ifdef CONFIG_CAPACITIVE_TOUCH_SENSOR_SHCTS
    {
        I2C_FFA,
        APQ_8064_GSBI2_QUP_I2C_BUS_ID,
        shcts_i2c_board_info,
        ARRAY_SIZE(shcts_i2c_board_info),
    },
#endif /* CONFIG_CAPACITIVE_TOUCH_SENSOR_SHCTS */
#ifdef CONFIG_SHVIBRATOR_LINEAR
    {
        ...
        APQ_8064_GSBI7_QUP_I2C_BUS_ID,
        msm_vib_board_info,
        ARRAY_SIZE(msm_vib_board_info),
    },
#endif /* CONFIG_SHVIBRATOR_LINEAR */
};
...
static void __init register_i2c_devices(void)
{
	...
	else if (machine_is_lynx_dl32())
		mach_mask = I2C_FFA;
	else if (machine_is_lynx_dl35())
		mach_mask = I2C_FFA;
	else if (machine_is_lynx_gp6d())
		mach_mask = I2C_FFA;
	else if (machine_is_deckard_as96())
		mach_mask = I2C_FFA;
	else if (machine_is_tadanobu())
		mach_mask = I2C_FFA;
	else
...
static void __init apq8064_common_init(void)
{
...
#if	defined(CONFIG_SHSYS_CUST)
	apq8064_device_qup_spi_gsbi3.dev.platform_data =
						&apq8064_qup_spi_gsbi3_pdata;
	if (machine_is_lynx_dl32() || machine_is_deckard_as96() || machine_is_tadanobu() || machine_is_lynx_gp6d()) {
		apq8064_device_qup_spi_gsbi6.dev.platform_data =
							&apq8064_qup_spi_gsbi6_pdata;
	}
#else	/* defined(CONFIG_SHSYS_CUST) */
...
#if	defined(CONFIG_SHSYS_CUST)
	if (machine_is_lynx_dl32() || machine_is_deckard_as96() || machine_is_tadanobu() || machine_is_lynx_gp6d()) {
		platform_add_devices(early_common_devices_calimero,
					ARRAY_SIZE(early_common_devices_calimero));
	}
#endif	/* defined(CONFIG_SHSYS_CUST) */
	if (socinfo_get_pmic_model() != PMIC_MODEL_PM8917)
	...
	if (!(machine_is_mpq8064_cdp() || machine_is_mpq8064_hrd() ||
			machine_is_mpq8064_dtv())) {
#ifdef	CONFIG_SH_GSBI1_I2C
		platform_add_devices(common_not_mpq_devices_gsbi1,
			ARRAY_SIZE(common_not_mpq_devices_gsbi1));
#endif	/* CONFIG_SH_GSBI1_I2C */
		platform_add_devices(common_not_mpq_devices,
			ARRAY_SIZE(common_not_mpq_devices));
#ifdef	CONFIG_SH_GSBI7_I2C
		platform_add_devices(common_not_mpq_devices_gsbi7,
			ARRAY_SIZE(common_not_mpq_devices_gsbi7));
#endif	/* CONFIG_SH_GSBI7_I2C */
...
static void __init apq8064_cdp_init(void)
{
...
#if	defined(CONFIG_SHFELICA)
		if (machine_is_lynx_dl32() || machine_is_lynx_dl35() || machine_is_deckard_as96() || machine_is_tadanobu()) {
			platform_device_register(&apq8064_device_uart_gsbi2);
		}
#else	/* CONFIG_SHFELICA */
#if	defined(CONFIG_SERIAL_MSM_HSL_CONSOLE)
		platform_device_register(&apq8064_device_uart_gsbi2);
#endif	/* defined(CONFIG_SERIAL_MSM_HSL_CONSOLE) */
#endif	/* defined(CONFIG_SHFELICA) */
	...
	if (machine_is_apq8064_cdp() || machine_is_apq8064_liquid() || machine_is_lynx_dl32() || machine_is_lynx_dl35() || machine_is_deckard_as96() || machine_is_tadanobu() || machine_is_lynx_gp6d())
#ifndef CONFIG_KEYBOARD_SCKEY
		platform_device_register(&cdp_kp_pdev);
#else
		platform_device_register(&sh_gpio_keys_pdev);
#endif /* CONFIG_KEYBOARD_SCKEY */
...
MACHINE_START(LYNX_DL32, "SHARP LYNX DL32")
	.map_io = apq8064_map_io,
	.reserve = apq8064_reserve,
	.init_irq = apq8064_init_irq,
	.handle_irq = gic_handle_irq,
...
MACHINE_START(LYNX_DL35, "SHARP LYNX DL35")
	.map_io = apq8064_map_io,
	.reserve = apq8064_reserve,
	.init_irq = apq8064_init_irq,
	.handle_irq = gic_handle_irq,
...
MACHINE_START(LYNX_GP6D, "SHARP LYNX GP6D")
	.map_io = apq8064_map_io,
	.reserve = apq8064_reserve,
	.init_irq = apq8064_init_irq,
	.handle_irq = gic_handle_irq,
...
MACHINE_START(DECKARD_AS96, "SHARP DECKARD AS96")
	.map_io = apq8064_map_io,
	.reserve = apq8064_reserve,
	.init_irq = apq8064_init_irq,
	.handle_irq = gic_handle_irq,
