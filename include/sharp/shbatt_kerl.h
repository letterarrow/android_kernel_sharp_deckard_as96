...
typedef enum shbatt_cpu_clock_level_tag
{
	...
	SHBATT_CPU_CLOCK_LEVEL6,
	SHBATT_CPU_CLOCK_LEVEL7,
...
typedef struct shbatt_hdq_read_tag
{
	unsigned char addr_read;
	unsigned char byte_read;
	
}shbatt_hdq_read_t;

typedef struct shbatt_hdq_write_tag
{
	unsigned char addr_write;
