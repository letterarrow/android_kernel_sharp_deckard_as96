...
#if 1
#define CFG_GET_SNAPSHOT_INFO           (CFG_MAX + 101)
#define CFG_SET_ACTUATOR_TABLE          (CFG_MAX + 102)
#define CFG_SET_OIS_INIT                (CFG_MAX + 103)
#define CFG_SET_OIS_MODE                (CFG_MAX + 104)

#define CFG_SHDIAG_GET_I2C_DATA         (CFG_MAX + 201)
#define CFG_SHDIAG_SET_I2C_DATA         (CFG_MAX + 202)
#define CFG_SHDIAG_GET_OTP_DATA         (CFG_MAX + 203)
#define CFG_SHDIAG_ACTUATOR_SET_TABLE   (CFG_MAX + 204)
#define CFG_SH_SET_EXP_GAIN             (CFG_MAX + 205)
#define CFG_SH_GET_DENOISE_INFO         (CFG_MAX + 206)
#define CFG_SHDIAG_AE_LOCK              (CFG_MAX + 207)
#endif
...
#if 1
	SENSOR_HDR_UPDATE_ATR,
#endif
};

#if 1
struct sensor_hdr_atr_update_parm_t {
  int32_t tc_out_noise;
  int32_t tc_out_mid;
  int32_t tc_out_sat;
  int32_t tc_noise_brate;
  int32_t tc_mid_brate;
  int32_t tc_sat_brate;
  int32_t turn_off;
  int32_t atr_temporal;
  int32_t integ_ratio;
  int32_t afd_status;
  int32_t blend_L;
  int32_t blend_H;
...
#if 1
	struct sensor_hdr_atr_update_parm_t atr_params;
#endif
};
...
struct ois_info_t {
	...
	uint16_t kgxg;
	uint16_t kgyg;
	uint16_t sfthal_x_16_9;
	uint16_t sfthal_y_16_9;
	uint16_t sfthal_x_4_3;
	uint16_t sfthal_y_4_3;
};
#endif
...
#if 1
enum ois_mode {
	SHCAM_OIS_MODE_STILL_ON,
	SHCAM_OIS_MODE_STILL_ON_CHG,
	SHCAM_OIS_MODE_STILL_OFF,
	SHCAM_OIS_MODE_STILL_OFF_CHG,
	SHCAM_OIS_MODE_VIDEO_16_9_ON,
	SHCAM_OIS_MODE_VIDEO_16_9_ON_CHG,
	SHCAM_OIS_MODE_VIDEO_16_9_OFF,
	SHCAM_OIS_MODE_VIDEO_16_9_OFF_CHG,
	SHCAM_OIS_MODE_VIDEO_4_3_ON,
	SHCAM_OIS_MODE_VIDEO_4_3_ON_CHG,
	SHCAM_OIS_MODE_VIDEO_4_3_OFF,
	SHCAM_OIS_MODE_VIDEO_4_3_OFF_CHG
};
#endif
...
struct msm_actuator_cfg_data {
	...
	union {
		...
		struct af_adjust_info_t af_adjust_info;
		struct ois_info_t ois_info;
#endif
	} cfg;
};
...
#if defined(CONFIG_IMX111)  || defined(FEATURE_SH_CAMERA_OCTOPUS)
